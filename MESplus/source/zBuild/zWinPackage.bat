@echo off
REM %1 : Target MESplus Home, if value is "X" then not include upgrade directory
...
echo \obj       >  zExclude.dat
echo \bin       >> zExclude.dat
echo \Release   >> zExclude.dat
echo \Debug     >> zExclude.dat
echo \_Image    >> zExclude.dat
echo .obj       >> zExclude.dat
echo .suo       >> zExclude.dat
echo .user      >> zExclude.dat
xcopy .\..\Client              MESplusV5\source\client /S/EXCLUDE:zExclude.dat
rmdir /S /Q                    MESplusV5\source\client\FMBClient\Miracom.FMBUI
rmdir /S /Q                    MESplusV5\source\client\MESClient\DiagramModeler
rmdir /S /Q                    MESplusV5\source\client\MESClient\MESplusUpgradeFtp
rmdir /S /Q                    MESplusV5\source\client\MESClient\MESplusUpgradeMsg
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.IngotMap
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.MsgHandlerH101
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.MsgHandlerTibRv
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.MsgHandlerHTTP
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.TRSConvertor
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.TRSCore
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.UI
rmdir /S /Q                    MESplusV5\source\client\MESClient\Miracom.WFMCore
rmdir /S /Q                    MESplusV5\source\client\SPCClient\Miracom.Stat
rmdir /S /Q                    MESplusV5\source\client\SPCClient\SPCControlChart
del zExclude.dat /Q

if %1=="X"	goto NEXT2
xcopy %MESHOME_DIR%\upgrade    MESplusV5\upgrade\ /S
