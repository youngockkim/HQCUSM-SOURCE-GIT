/*******************************************************************************
    ...
    File Name   : CINF_download_mm104_stock_transfer.c
...
*******************************************************************************/
int CUS_Interface_Download_Stock_Transfer(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CUS_INTERFACE_DOWNLOAD_STOCK_TRANSFER(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CUS_Interface_Download_Stock_Transfer", out_node);
...
/*******************************************************************************
    CUS_INTERFACE_DOWNLOAD_STOCK_TRANSFER()
        - ERP->MES Stock Transfer Information
    return Value
        - int : 0 (MP_TRUE)
    Arguments
        ...
        - TRSNode *out_node : Output Message structure  
*******************************************************************************/
int CUS_INTERFACE_DOWNLOAD_STOCK_TRANSFER(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node)
{
	// INIT
	...
	while(1)
	{
		...
		if(INV_TRANSFER_INVENTORY(s_msg_code, in_node1, out_node1) == MP_FALSE){
			...
			memcpy(IINVSTKTRS.RETURN_MSG, s_msg_code, strlen(s_msg_code));
            ...
            */
            ...
            COM_out_msg_log_write(s_msg_code, "CUS_Interface_Download_Stock_Transfer", out_node1);
