...
int CSUM_BATCHPROCESS_TRANSACTION(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
int CSUM_BatchProcess_Transaction_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CSUM_BatchProcess_Transaction(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CSUM_BATCHPROCESS_TRANSACTION(s_msg_code, in_node, out_node);
...
int CSUM_BATCHPROCESS_TRANSACTION(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("CSUM_BATCHPROCESS_TRANSACTION");
...
- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CSUM_BATCHPROCESS_EOH(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
	struct worktime_tag cur_work_time;
