...
int CSUM_BATCHPROCESS_EVENT_E1(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
/*******************************************************************************
CSUM_BatchProcess_Event_E1()
- End Lot
Return Value
- int : 0 (MP_TRUE)
Arguments
...
*******************************************************************************/
int CSUM_BatchProcess_Event_E1(TRSNode *in_node, TRSNode *out_node)
{
	...
	*/
	...
	i_ret = CSUM_BATCHPROCESS_EVENT_E1(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code, "CSUM_BATCHPROCESS_EVENT_E1", out_node);
...
/*******************************************************************************
CSUM_BATCHPROCESS_EVENT_E1()
- Main sub function of "CSUM_BatchProcess_Event_E1" function
Return Value
...
int CSUM_BATCHPROCESS_EVENT_E1(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("CSUM_BATCHPROCESS_EVENT_E1");
