/*******************************************************************************
    ...
    File Name   : CINF_download_pp107_production_routing_Gerp.c
	...
	2	  2023.02.13  JaeDong.Park		 Update
...
int CUS_INTERFACE_DOWNLOAD_PRODUCTION_ROUTING_GERP(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node);
...
*******************************************************************************/
int CUS_Interface_Download_Production_Routing_Gerp(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CUS_INTERFACE_DOWNLOAD_PRODUCTION_ROUTING_GERP(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CUS_Interface_Download_Production_Routing_Gerp", out_node);
...
/*******************************************************************************
    CUS_INTERFACE_DOWNLOAD_PRODUCTION_ROUTING_GERP()
                        ...
                        TRSNode *out_node)
{
	...
	while(1) 
    {
		...
		/* MES-2034 */
		/* 2023.02.13 */
		/* IWIPORDRTE(CMF_1, CMF_2) -> CWIPORDRTE(CMF_1, CMF_2) */ 
		memcpy(CWIPORDRTE.CMF_1, IWIPORDRTE.CMF_1, sizeof(CWIPORDRTE.CMF_1));
		memcpy(CWIPORDRTE.CMF_2, IWIPORDRTE.CMF_2, sizeof(CWIPORDRTE.CMF_2));
