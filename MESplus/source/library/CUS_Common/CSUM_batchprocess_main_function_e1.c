...
File Name   : CSUM_BatchProcess_MainFunction_E1.c
...
int CSUM_BATCHPROCESS_TRANSACTION_E1(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
int CSUM_BatchProcess_Transaction_E1_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);

/*******************************************************************************
CSUM_BatchProcess_Transaction_E1()
- End Lot
Return Value
- int : 0 (MP_TRUE)
Arguments
...
*******************************************************************************/
int CSUM_BatchProcess_Transaction_E1(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CSUM_BATCHPROCESS_TRANSACTION_E1(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code, "CSUM_BATCHPROCESS_TRANSACTION_E1", out_node);
...
/*******************************************************************************
CSUM_BATCHPROCESS_TRANSACTION_E1()
- Main sub function of "CSUM_BatchProcess_Transaction_E1" function
Return Value
...
int CSUM_BATCHPROCESS_TRANSACTION_E1(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("CSUM_BATCHPROCESS_TRANSACTION_E1");
...
/*******************************************************************************
CSUM_BatchProcess_Transaction_Validation()
...
- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CSUM_BATCHPROCESS_EOH_E1(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
	struct worktime_tag cur_work_time;
