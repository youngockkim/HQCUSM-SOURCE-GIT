/*******************************************************************************
    ...
    File Name   : CINF_download_sd201_article_master_gerp.c
...
int CUS_INTERFACE_DOWNLOAD_ARTICLE_MASTER_GERP(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node);
...
*******************************************************************************/
int CUS_Interface_Download_Article_Master_Gerp(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CUS_INTERFACE_DOWNLOAD_ARTICLE_MASTER_GERP(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CUS_Interface_Download_Article_Master_Gerp", out_node);
...
/*******************************************************************************
    CUS_INTERFACE_DOWNLOAD_ARTICLE_MASTER_GERP()
                        ...
                        TRSNode *out_node)
{
	...
	while(1) 
    {
		...
		/* 2023 - 01 - 30 */
		/* RICEF : MES-2044 */
		/* New ZMDL Material Number Rcv */
		/* IBASARTDEF.CMF_1       -> MGCMLAGDAT.DATA_6  (New) */
		TRS.add_string(list_item, "DATA_6", IBASARTDEF.CMF_1, sizeof(IBASARTDEF.CMF_1));
		...
		if(BAS_UPDATE_DATA_LIST(s_msg_code, in_node1, out_node1)== MP_FALSE)
		{
			...
			*/
			...
			// IS-21-07-007 ERP 인터페이스 방어로직 개발(Power Range)
			COM_out_msg_log_write(s_msg_code, "CUS_Interface_Download_Article_Master_Gerp", out_node1);
