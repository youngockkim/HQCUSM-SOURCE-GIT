/*******************************************************************************
    ...
    File Name   : RTD_scheduled_lot_start_time.c
...
int RTD_Scheduled_Lot_Start_Time_1(TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("RTD_Scheduled_Lot_Start_Time_1");
    ...
    //Default Result
    TRS.set_nstring(out_node, "TIME_VALUE", "20101231235959");
    ...
    TRS.set_string(out_node, "TIME_VALUE", MWIPLOTSTS.START_TIME, sizeof(MWIPLOTSTS.START_TIME));
