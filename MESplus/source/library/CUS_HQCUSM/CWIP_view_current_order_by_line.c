/******************************************************************************'
	...
	System      : MESplus
	Module      : CWIP
	File Name   : CWIP_view_current_order_by_line.c
	Description : View Current Order by Line

    MES Version : 5.3.6.4

	Function List  
		- CWIP_View_Current_Order_By_Line()
			+ View Work Order
		- CWIP_VIEW_CURRENT_ORDER_BY_LINE()
			+ Main sub function of CWIP_View_Current_Order_By_Line function
			+ View Work Order definition
		- CWIP_View_Current_Order_By_Line_Validation()
			+ Main sub function of CWIP_VIEW_CURRENT_ORDER_BY_LINE function
...
int CWIP_View_Current_Order_By_Line_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
int CWIP_VIEW_CURRENT_ORDER_BY_LINE(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CWIP_View_Current_Order_By_Line(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CWIP_VIEW_CURRENT_ORDER_BY_LINE(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code,"CWIP_VIEW_CURRENT_ORDER_BY_LINE", out_node);
...
{ 
    ...
    LOG_head("CWIP_VIEW_CURRENT_ORDER_BY_LINE");
    TRS.log_add_all_members(in_node);
    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_LOGIC, MP_LOG_CATE_TRANS);

    if(CWIP_View_Current_Order_By_Line_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CWIP_View_Current_Order_By_Line_Validation(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
