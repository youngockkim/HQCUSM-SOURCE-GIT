/*******************************************************************************
    ...
    System      : MESplus
    Module      : CRPT_View_Halfcell_Cart_Label
    File Name   : CRPT_View_Halfcell_Cart_Label.c
...
int CRPT_View_Halfcell_Cart_Label_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);

/*******************************************************************************
    CRPT_View_Halfcell_Cart_Label()
        - View_Halfcell_Cart_Label
    return Value
        - int : 0 (MP_TRUE)
    Arguments
...
*******************************************************************************/
int CRPT_View_Halfcell_Cart_Label(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CRPT_VIEW_HALFCELL_CART_LABEL(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CRPT_View_Halfcell_Cart_Label", out_node);
...
/*******************************************************************************
    ...
    Arguments
        ...
        - TRSNode *out_node : Output Message structure  
*******************************************************************************/
int CRPT_VIEW_HALFCELL_CART_LABEL(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node)
{
	...
	char s_sys_time[14];
    int i_step;
    double numCellBoxes = 0;
    double numMagazines = 0;
    ...
    */
    ...
    if(CRPT_View_Halfcell_Cart_Label_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
    ...
    TRS.add_int(out_node, "CART_SIZE", MRASCRRDEF.CRR_SIZE);
	...
	TRS.add_double(out_node, "MODULE_PO_CNT", CWIPORDSTS.PROD_QTY);   
    */
	...
	numCellBoxes = CDB_select_cwipcelpak_scalar(12, &CWIPCELPAK);
	if(DB_error_code != DB_SUCCESS)
	{
		strcpy(s_msg_code, "WIP-0004");
	...
	TRS.add_double(out_node, "HALFCELL_CNT", numCellBoxes);
	...
	numMagazines = CDB_select_cwipcelpak_scalar(6, &CWIPCELPAK);
	if(DB_error_code != DB_SUCCESS)
	{
		strcpy(s_msg_code, "WIP-0004");
		TRS.add_fieldmsg(out_node, "CWIPCELPAK OPEN", MP_NVST);
	...
	TRS.add_double(out_node, "MAGAZINE_CNT", numMagazines);
	...
	TRS.add_double(out_node, "TOTAL_NUM_CELLS", totalNumCells);

    /* 5. Half Cell Delivery Slip */
	CDB_init_cwipcelpak(&CWIPCELPAK);
	TRS.copy(CWIPCELPAK.FACTORY, sizeof(CWIPCELPAK.FACTORY), in_node, IN_FACTORY);
	TRS.copy(CWIPCELPAK.LACK_ID, sizeof(CWIPCELPAK.LACK_ID), in_node, "LACK_ID");
    CWIPCELPAK.PACK_TYPE = 'H';
	...
	while(1)
	{
	    ...
	    CDB_init_cwipordsts(&CWIPORDSTS);
	    TRS.copy(CWIPORDSTS.FACTORY, sizeof(CWIPORDSTS.FACTORY), in_node, IN_FACTORY);
        memcpy(CWIPORDSTS.ORDER_ID, MWIPLOTHIS.TRAN_CMF_2, sizeof(CWIPORDSTS.ORDER_ID));
        ...
        TRS.add_double(out_node, "MODULE_PO_QTY", CWIPORDSTS.PROD_QTY);   

        /* Line */
        DBC_init_mgcmtbldat(&MGCMTBLDAT);
        TRS.copy(MGCMTBLDAT.FACTORY, sizeof(MGCMTBLDAT.FACTORY), in_node, IN_FACTORY);
        memcpy(MGCMTBLDAT.TABLE_NAME, HQCEL_M1_GCM_LINE_CODE, strlen(HQCEL_M1_GCM_LINE_CODE));
        memcpy(MGCMTBLDAT.KEY_1, MWIPLOTHIS.TRAN_CMF_1, sizeof(MGCMTBLDAT.KEY_1));
        ...
        memcpy(MRASRESDEF.RES_ID, CWIPCELPAK.CMF_6, sizeof(MRASRESDEF.RES_ID));
        ...
        /* From CWIPCELPAK */
        TRS.add_string(list_item, "CART_ID", CWIPCELPAK.LACK_ID, sizeof(CWIPCELPAK.LACK_ID));
        TRS.add_string(list_item, "MAGAZINE", CWIPCELPAK.PACK_ID, sizeof(CWIPCELPAK.PACK_ID));
		TRS.add_int(list_item, "QTY", CWIPCELPAK.PACK_QTY);
        ...
        TRS.add_string(list_item, "CLEAVING_TIME", CWIPCELPAK.CMF_1, 14);
        TRS.add_string(list_item, "CLEAVING_NO", CWIPCELPAK.CMF_6, sizeof(CWIPCELPAK.CMF_6));
        TRS.add_string(list_item, "CLEAVING_DESC", MRASRESDEF.RES_DESC, sizeof(MRASRESDEF.RES_DESC));
		TRS.add_double(list_item, "STOCK_CELL",0);
		TRS.add_string(list_item, "DATE_TIME", s_sys_time, sizeof(s_sys_time));

		/* From MWIPLOTHIS */
        TRS.add_string(list_item, "LINE", MWIPLOTHIS.TRAN_CMF_1, sizeof(MWIPLOTHIS.TRAN_CMF_1));
        TRS.add_string(list_item, "LINE_DESC", MGCMTBLDAT.DATA_1, sizeof(MGCMTBLDAT.DATA_1));
        TRS.add_string(list_item, "MODULE_PO", MWIPLOTHIS.TRAN_CMF_2, sizeof(MWIPLOTHIS.TRAN_CMF_2));
        TRS.add_string(list_item, "ORDER_EFFICIENCY", MWIPLOTHIS.TRAN_CMF_3, sizeof(MWIPLOTHIS.TRAN_CMF_3));
        TRS.add_string(list_item, "ORDER_GRADE", MWIPLOTHIS.TRAN_CMF_4, sizeof(MWIPLOTHIS.TRAN_CMF_4));
...
/*******************************************************************************
	CRPT_View_Halfcell_Cart_Label_Validation()
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CRPT_View_Halfcell_Cart_Label_Validation(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
	...
	TRS.copy(MRASCRRDEF.FACTORY, sizeof(MRASCRRDEF.FACTORY), in_node, IN_FACTORY);
	TRS.copy(MRASCRRDEF.CRR_ID, sizeof(MRASCRRDEF.CRR_ID), in_node,"LACK_ID");
	memcpy(MRASCRRDEF.CRR_GROUP, "US_FH_C", strlen("US_FH_C"));
