/******************************************************************************'
	...
	System      : MESplus
	Module      : CWIP
	File Name   : CBAS_view_Module_grade_list.c
	...
	Function List  
		- CBAS_view_Module_grade_list()
			+ View Lot
		- CBAS_view_Module_grade_list()
			+ Main sub function of CBAS_view_Module_grade_list function
...
int CBAS_view_Module_grade_list_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CBAS_view_Module_grade_list(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CBAS_VIEW_MODULE_GRADE_LIST(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code,"CBAS_view_Module_grade_list", out_node);
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CBAS_VIEW_MODULE_GRADE_LIST(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{ 
    ...
    LOG_head("CBAS_view_Module_grade_list");
    TRS.log_add_all_members(in_node);
    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_LOGIC, MP_LOG_CATE_TRANS);

    if(CBAS_view_Module_grade_list_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
	...
	{
		i_step = 102;
		TRS.copy(MGCMLAGDAT.KEY_2, sizeof(MGCMLAGDAT.KEY_2), in_node, "KEY_2");
    ...
    while(1) 
    {
		...
		TRS.add_string(list_item, "KEY_1", MGCMLAGDAT.KEY_1, sizeof(MGCMLAGDAT.KEY_1));
        TRS.add_string(list_item, "KEY_2", MGCMLAGDAT.KEY_2, sizeof(MGCMLAGDAT.KEY_2));
		...
		{
		TRS.add_string(list_item, "KEY_1", MGCMLAGDAT.KEY_1, sizeof(MGCMLAGDAT.KEY_1));
        TRS.add_string(list_item, "KEY_2", MGCMLAGDAT.KEY_2, sizeof(MGCMLAGDAT.KEY_3));
		}*/
    }
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CBAS_view_Module_grade_list_Validation(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
