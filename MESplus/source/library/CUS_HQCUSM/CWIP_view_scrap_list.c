...
int CWIP_View_Scrap_List_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CWIP_View_Scrap_List(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CWIP_VIEW_SCRAP_LIST(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code, "CWIP_VIEW_SCRAP_LIST", out_node);
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CWIP_VIEW_SCRAP_LIST(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{ 
    ...
    */
    ...
    if(CWIP_View_Scrap_List_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
    ...
    while(1)
    {
        ...
        TRS.add_string(list_item, "CMF_1", RSUMWIPLOS.CMF_1, sizeof(RSUMWIPLOS.CMF_1));
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CWIP_View_Scrap_List_Validation(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
