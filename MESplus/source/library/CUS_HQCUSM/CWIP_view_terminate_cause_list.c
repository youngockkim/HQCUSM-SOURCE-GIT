/******************************************************************************'
	...
	Function List  
		- CWIP_View_Terminate_Cause_List()
			+ View Lot
		- CWIP_VIEW_TERMINATE_CAUSE_LIST()
			+ Main sub function of CWIP_View_Terminate_Cause_List function
			+ View Line List definition
		- CWIP_View_Terminate_Cause_List_Validation()
			+ Main sub function of CWIP_VIEW_TERMINATE_CAUSE_LIST function
...
int CWIP_View_Terminate_Cause_List_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CWIP_View_Terminate_Cause_List(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CWIP_VIEW_TERMINATE_CAUSE_LIST(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code,"CWIP_VIEW_TERMINATE_CAUSE_LIST", out_node);
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CWIP_VIEW_TERMINATE_CAUSE_LIST(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{ 
    ...
    LOG_head("CWIP_VIEW_TERMINATE_CAUSE_LIST");
    TRS.log_add_all_members(in_node);
    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_LOGIC, MP_LOG_CATE_TRANS);

    if(CWIP_View_Terminate_Cause_List_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CWIP_View_Terminate_Cause_List_Validation(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
