...
int CWIP_VIEW_PACKING_LABEL_PRINT_V1(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node);


/*******************************************************************************
    CWIP_View_Packing_Label_Print_V1()
...
*******************************************************************************/
int CWIP_View_Packing_Label_Print_V1(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CWIP_VIEW_PACKING_LABEL_PRINT_V1(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CWIP_View_Packing_Label_Print_V1", out_node);
                        ...
                        TRSNode *out_node)
{
	...
	while(1)
	{
		...
		//[06.14]등급 외 출력시 ZMDL로 표시 하도록 함
		TRS.add_string(list_item, "ZMDL", MGCMLAGDAT_Z.DATA_4, sizeof(MGCMLAGDAT_Z.DATA_4));//ZMATNR
		//[06.14]등급 외 출력시 ZMDL로 표시 하도록 함
