/*******************************************************************************
    ...
    System      : MESplus
    Module      : Update Cleaving Loss
    File Name   : CWIP_update_cleaving_loss.c
...
int CWIP_Update_Cleaving_Loss_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
int CWIP_UPDATE_CLEAVING_LOSS(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);


/*******************************************************************************
    CWIP_Update_Cleaving_Loss()
...
*******************************************************************************/
int CWIP_Update_Cleaving_Loss(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CWIP_UPDATE_CLEAVING_LOSS(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CWIP_Update_Cleaving_Loss", out_node);
...
/*******************************************************************************
    ...
    Arguments
        ...
        - TRSNode *out_node : Output Message structure  
*******************************************************************************/
int CWIP_UPDATE_CLEAVING_LOSS(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
	...
	LOG_head("CWIP_UPDATE_CLEAVING_LOSS");
	TRS.log_add_all_members(in_node);
	COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_LOGIC, MP_LOG_CATE_TRANS);

	if(CWIP_Update_Cleaving_Loss_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
	...
	//CWIPCLVLOS.EFF = TRS.get_double(in_node, "EFF");
	...
	CWIPCLVLOS.FC_CHIP_QTY = TRS.get_double(in_node, "FC_CHIP_QTY");
	CWIPCLVLOS.FC_BROKEN_QTY = TRS.get_double(in_node, "FC_BROKEN_QTY");

	CWIPCLVLOS.HC_HANDLING_QTY = TRS.get_double(in_node, "HC_HANDLING_QTY");
	CWIPCLVLOS.HC_CRACK_QTY = TRS.get_double(in_node, "HC_CRACK_QTY");
	CWIPCLVLOS.HC_SICKLE_QTY = TRS.get_double(in_node, "HC_SICKLE_QTY");
	CWIPCLVLOS.HC_C_SICKLE_QTY = TRS.get_double(in_node, "HC_C_SICKLE_QTY");
	CWIPCLVLOS.HC_ALIGN_QTY = TRS.get_double(in_node, "HC_ALIGN_QTY");
	CWIPCLVLOS.HC_ETC_QTY = TRS.get_double(in_node, "HC_ETC_QTY");

	CWIPCLVLOS.CJ_BROKEN_QTY = TRS.get_double(in_node, "CJ_BROKEN_QTY");
...
/*******************************************************************************
	...
	Arguments
		...
		- TRSNode *out_node : Output Message structure
*******************************************************************************/
int CWIP_Update_Cleaving_Loss_Validation(char *s_msg_code,
									TRSNode *in_node,
									TRSNode *out_node)
{
