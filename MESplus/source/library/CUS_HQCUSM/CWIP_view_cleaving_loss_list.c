/*******************************************************************************
    ...
    System      : MESplus
    Module      : View Cleaving Loss List
    File Name   : CWIP_update_cleaving_loss_list.c
...
int CWIP_VIEW_CLEAVING_LOSS_LIST(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node);
...
*******************************************************************************/
int CWIP_View_Cleaving_Loss_List(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CWIP_VIEW_CLEAVING_LOSS_LIST(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CWIP_View_Cleaving_Loss_List", out_node);
...
/*******************************************************************************
    CWIP_VIEW_CLEAVING_LOSS_LIST()
        - VIEW CLEAVING LOSS LIST
    return Value
        - int : 0 (MP_TRUE)
    Arguments
									...
									TRSNode *out_node)
{
	...
	LOG_head("CWIP_VIEW_CLEAVING_LOSS_LIST");
    ...
    TRS.copy(CWIPCLVLOS.CMF_1, sizeof(CWIPCLVLOS.CMF_1), in_node, "FROM_DATE");
    TRS.copy(CWIPCLVLOS.CMF_2, sizeof(CWIPCLVLOS.CMF_2), in_node, "TO_DATE");
	...
	while(1)
	{
        ...
        //TRS.add_double(list_item, "EFF", CWIPCLVLOS.EFF);
        ...
        TRS.add_double(list_item, "FC_CHIP_QTY", CWIPCLVLOS.FC_CHIP_QTY);
        TRS.add_double(list_item, "FC_BROKEN_QTY", CWIPCLVLOS.FC_BROKEN_QTY);
        TRS.add_double(list_item, "HC_HANDLING_QTY", CWIPCLVLOS.HC_HANDLING_QTY);
        TRS.add_double(list_item, "HC_CRACK_QTY", CWIPCLVLOS.HC_CRACK_QTY);
        TRS.add_double(list_item, "HC_SICKLE_QTY", CWIPCLVLOS.HC_SICKLE_QTY);
        TRS.add_double(list_item, "HC_C_SICKLE_QTY", CWIPCLVLOS.HC_C_SICKLE_QTY);
        TRS.add_double(list_item, "HC_ALIGN_QTY", CWIPCLVLOS.HC_ALIGN_QTY);
        TRS.add_double(list_item, "HC_ETC_QTY", CWIPCLVLOS.HC_ETC_QTY);
        TRS.add_double(list_item, "CJ_BROKEN_QTY", CWIPCLVLOS.CJ_BROKEN_QTY);
