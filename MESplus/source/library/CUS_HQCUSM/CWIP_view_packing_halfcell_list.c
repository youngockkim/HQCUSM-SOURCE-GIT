/*******************************************************************************
    ...
    System      : MESplus
    Module      : View Packing HalfCell List
    File Name   : CWIP_packing_halfcell_list.c
    Description : SOI -> MES
...
/*******************************************************************************
    CWIP_View_Packing_Halfcell_List()
        - View Packing HalfCell List
    return Value
        - int : 0 (MP_TRUE)
    Arguments
...
*******************************************************************************/
int CWIP_View_Packing_Halfcell_List(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CWIP_VIEW_PACKING_HALFCELL_LIST(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CWIP_View_Packing_Halfcell_List", out_node);
...
/*******************************************************************************
    ...
    Arguments
        ...
        - TRSNode *out_node : Output Message structure  
*******************************************************************************/
int CWIP_VIEW_PACKING_HALFCELL_LIST(char *s_msg_code,
                        TRSNode *in_node, 
                        TRSNode *out_node)
{
	// INIT
	...
	// PROCESS LOG PRINT
	LOG_head("CWIP_VIEW_PACKING_HALFCELL_LIST");
