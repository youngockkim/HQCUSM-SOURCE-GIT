...
int EAPMES_RELEASECONFIRM_RECIPE(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);	// CUS_HQCUSM_common.h 선언해주면 필요없음
...
*******************************************************************************/
int EAPMES_ReleaseConfirm_Recipe(TRSNode *in_node)		// CUS_HQCUSM_service.h	/ CUSHQCUSMAddService.c 선언 추가
{	
...
/*******************************************************************************
    ...
    Arguments
        ...
        - TRSNode *out_node : Output Message structure
*******************************************************************************/
int EAPMES_RELEASECONFIRM_RECIPE(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)	// CUS_HQCUSM_common.h 선언 추가
{
	// 사용할 변수 선언  
