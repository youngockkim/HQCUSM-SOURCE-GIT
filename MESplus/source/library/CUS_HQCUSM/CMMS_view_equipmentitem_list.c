/******************************************************************************'
    ...
    System      : MESplus
    Module      : CMMS
    File Name   : CMMS_view_equipmentitem_list.c
    Description : View EquipmentItem List function module

    MES Version : 5.3.4 ~

    Function List
        - CMMS_View_EquipmentItem_List()
            + View EquipmentItem definition List
        - CMMS_VIEW_EQUIPMENTITEM_LIST()
            + Main sub function of CMMS_View_EquipmentItem_List function
            + View EquipmentItem definition List
    Detail Description
        - CMMS_VIEW_EQUIPMENTITEM_LIST()
            + h_proc_step
                + 1 : View EquipmentItem definition List by Primary Key
    History
...
*******************************************************************************/
int CMMS_View_EquipmentItem_List(TRSNode *in_node, TRSNode *out_node)
{
    ...
    i_ret = CMMS_VIEW_EQUIPMENTITEM_LIST(s_msg_code, in_node, out_node);

    COM_out_msg_log_write(s_msg_code, "CMMS_VIEW_EQUIPMENTITEM_LIST", out_node);
...
/*******************************************************************************
    ...
    Arguments
        ...
        - TRSNode *out_node : Output Message structure
*******************************************************************************/
int CMMS_VIEW_EQUIPMENTITEM_LIST(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("CMMS_VIEW_EQUIPMENTITEM_LIST");
    ...
    if(COM_proc_user_routine("CMMS", "CMMS_View_EquipmentItem_List",
                             MP_UPOINT_BEFORE,
                             in_node,
    ...
    */
    ...
    while(1)
    {
        ...
        list_item = TRS.add_node(out_node, "EQUIPMENTITEM_LIST");
