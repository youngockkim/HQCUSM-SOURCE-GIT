...
#ifndef _CMN_SERVICES_H
#define _CMN_SERVICES_H
...
DllExport int UCMN_prologue_1(TRSNode *in_node, TRSNode *out_node);
DllExport int UCMN_epilogue_1(TRSNode *in_node, TRSNode *out_node);
DllExport int UCMN_server_start_1(TRSNode *in_node, TRSNode *out_node);
