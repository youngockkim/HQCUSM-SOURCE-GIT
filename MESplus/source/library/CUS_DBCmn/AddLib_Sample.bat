...
REM ---------------------
call %4\vcvarsall.bat x86
REM call %4\vcvarsall.bat x64
REM ---------------------
...
REM If it want to skip SQLCHECK then use as below.
    proc PARSE=PARTIAL iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
) ELSE IF %1 == DBC_semantics_file (
REM If it used Stored Procedure in PC file then use as below.
    proc PARSE=PARTIAL SQLCHECK=SEMANTICS USERID=mesmgr/mesmgr@ORAMES iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
) ELSE (
REM Normal PC files
    proc PARSE=PARTIAL SQLCHECK=FULL USERID=mesmgr/mesmgr@ORAMES iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
)
