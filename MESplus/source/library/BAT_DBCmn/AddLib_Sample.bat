...
IF %1 == BDB_semantics_file (
    proc PARSE=PARTIAL SQLCHECK=SEMANTICS USERID=mesmgr/mesmgr@ORAMES11 iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
) ELSE (
