/*******************************************************************************
    ...
    File Name   : UWIP_Skip_Lot.c
    Description : User Routine for WIP_Skip_Lot
...
int WIP_Skip_Lot_Before_1(TRSNode *in_node, TRSNode *out_node)
{
...
int WIP_Skip_Lot_After_1(TRSNode *in_node, TRSNode *out_node)
{
    /* TODO : Insert your code */	
