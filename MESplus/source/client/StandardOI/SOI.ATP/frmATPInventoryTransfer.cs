...
namespace SOI.ATP
{
    ...
    public partial class frmATPInventoryTransfer : SOIBaseForm02
    {
        #region Property
        ...
        public frmATPInventoryTransfer()
        {
            InitializeComponent();
        }
        ...
        private bool AddToScanList(string invLotID)
        {
            try
            {
                ...
                // Set Focus
                MPCF.SetFocusAndSelectAll(txtInvLotID);
        ...
        /// </summary>
        /// <returns></returns>
        private bool InventoryTransfer()
        {
            try
            {
                TRSNode in_node = new TRSNode("INV_TRANSFER_IN");
                TRSNode out_node = new TRSNode("INV_TRANSFER_OUT");
                TRSNode scanList;
                ...
                in_node.AddString("ACCT_CODE", "M05");
