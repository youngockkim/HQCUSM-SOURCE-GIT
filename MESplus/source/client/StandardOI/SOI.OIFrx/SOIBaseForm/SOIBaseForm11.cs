...
{
    public partial class SOIBaseForm11 : Form
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void SOIBaseForm11_Load(object sender, EventArgs e)
        {
            if (DesignMode == true)
            {
                SetOITheme();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SOIBaseForm11_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                // Message Bar를 초기화 합니다.
            ...
            {
                MPCF.ShowMessage("SOIBaseForm11_FormClosed() \n" + ex.Message, MSG_LEVEL.ERROR, false);
            }
        }
