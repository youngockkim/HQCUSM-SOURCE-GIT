...
{
    public partial class SOIBaseForm01 : Form
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void SOIBaseForm01_Load(object sender, EventArgs e)
        {
            if (DesignMode == true)
            {
                SetOITheme();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SOIBaseForm01_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                // 화면을 목록에서 제거
            ...
            {
                MPCF.ShowMessage("SOIBaseForm01_FormClosed() \n" + ex.Message, MSG_LEVEL.ERROR, false);
            }
        }
		...
		private void SOIBaseForm01_KeyDown(object sender, KeyEventArgs e)
		{
