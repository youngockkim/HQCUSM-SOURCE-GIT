    ...
    public partial class SOIListBox : UltraGrid
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.DisplayLayout.Appearance.BackColor = MPGV.gTheme.ListBoxBackground;
                ...
                this.DisplayLayout.Override.CellAppearance.BackColor = MPGV.gTheme.ListBoxRowBackground;
                this.DisplayLayout.Override.CellAppearance.BorderColor = MPGV.gTheme.ListBoxRowBackground;
                this.DisplayLayout.Override.CellAppearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                this.DisplayLayout.Override.CellAppearance.ForeColor = MPGV.gTheme.ListBoxRowForeground;
                this.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.Standard;
                this.DisplayLayout.Override.RowAppearance.BorderColor = MPGV.gTheme.ListBoxRowBackground;
                //this.DisplayLayout.DefaultSelectedBackColor = MPGV.gTheme.ListBoxRowBackground;
                this.DisplayLayout.DefaultSelectedBackColor = MPGV.gTheme.ListBoxRowSelectedBackground;
                ...
                {
                    this.DisplayLayout.Appearance.BorderColor = MPGV.gTheme.ListBoxBorder;
                }
                else if (_UseStyle == SOIListBoxStyle.MenuStyle)
                {
                    this.DisplayLayout.Appearance.BorderColor = MPGV.gTheme.ListBoxBorderForMenu;
                }
            }
        }
        ...
        {
            return MPCF.SetSOIListBoxAddRow(this, 0, false, rowText);
        }
        ...
        {
            return MPCF.SetSOIListBoxAddRow(this, 0, rowCheck, rowText);
        }
        ...
        public bool AddRowSeqAndText(string rowText)
        {
            try
            {
                ...
                return MPCF.SetSOIListBoxAddRow(this, rowSeq, false, rowText);
            }
            catch (Exception ex)
            {
