...
namespace SOI.OIFrx.SOIControls
{
    public partial class SOIFlexibleScreen : UserControl
    {
        ...
        private string ms_print_type;
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string PrintType
        {
            get { return ms_print_type; }
            set { ms_print_type = value; }
        }

        private string ms_customer_id;
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string CustomerId
        {
            get { return ms_customer_id; }
            set { ms_customer_id = value; }
        }

        private char ms_rel_level;
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public char RelLevel
        {
            get { return ms_rel_level; }
            set { ms_rel_level = value; }
        }

        private string ms_print_params_xml;
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string PrintParamsXml
        {
            get { return ms_print_params_xml; }
            set { ms_print_params_xml = value; }
        }

        private string ms_order_id;
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string OrderId
        {
            get { return ms_order_id; }
            set { ms_order_id = value; }
        }

        private string ms_base_path = MPGV.gsFlexibleScreenLocalPath;
        private Hashtable mh_screen_map = new Hashtable(); // Cell에 정의된 예약어($~)를 중복없이 저장하기 위한 용도 (ex. $LOT_ID)
        private Hashtable mh_screen_dtmx_map = new Hashtable(); // Cell에 정의된 DTMX 예약어(@DTMX$~)를 중복없이 저장하기 위한 용도 (ex. @DTMX$LOT_ID)
        private Hashtable mh_screen_word_art_map = new Hashtable(); // Farpoint Spread의 "WorkArt" 기능에 대해 예약어($~)를 중복없이 저장하기 위한 용도 (ex. $LOT_ID)
        ...
        public enum FLEXIBLE_SCREEN_DATA_TYPE
        {
            TEXT = 0,
            DTMX,
            WORD_ART
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.spdSpread.BackColor = MPGV.gTheme.SpreadBackground;
                if (this.spdSpread.Sheets.Count > 0)
                {
                    //this.spdSpread.Sheets[0].ActiveSkin = FarPoint.Win.Spread.DefaultSkins.Classic1;
                    this.spdSpread.Sheets[0].GrayAreaBackColor = MPGV.gTheme.SpreadBackground;

                    this.spdSpread.Sheets[0].ColumnHeader.DefaultStyle.BackColor = MPGV.gTheme.SpreadColumnHeaderBackground;
                    this.spdSpread.Sheets[0].ColumnHeader.DefaultStyle.ForeColor = MPGV.gTheme.SpreadColumnHeaderForeground;
                    ...
                    this.spdSpread.Sheets[0].ColumnHeader.HorizontalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);
                    this.spdSpread.Sheets[0].ColumnHeader.VerticalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);

                    //this.spdSpread.Sheets[0].ColumnHeader.Rows[0].Height = 30;

                    this.spdSpread.Sheets[0].RowHeader.DefaultStyle.BackColor = MPGV.gTheme.SpreadColumnHeaderBackground;
                    this.spdSpread.Sheets[0].RowHeader.DefaultStyle.ForeColor = MPGV.gTheme.SpreadColumnHeaderForeground;
                    ...
                    this.spdSpread.Sheets[0].RowHeader.HorizontalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);
                    this.spdSpread.Sheets[0].RowHeader.VerticalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);
                    ...
                    this.spdSpread.Sheets[0].SheetCorner.DefaultStyle.BackColor = MPGV.gTheme.SpreadColumnHeaderBackground;
                    this.spdSpread.Sheets[0].SheetCorner.DefaultStyle.ForeColor = MPGV.gTheme.SpreadColumnHeaderForeground;
                    ...
                    this.spdSpread.Sheets[0].SheetCorner.HorizontalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);
                    this.spdSpread.Sheets[0].SheetCorner.VerticalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);

                    this.spdSpread.Sheets[0].DefaultStyle.BackColor = MPGV.gTheme.FlexibleScreenBackground;
                    this.spdSpread.Sheets[0].DefaultStyle.ForeColor = MPGV.gTheme.FlexibleScreenCellForeground;
                    ...
                    this.spdSpread.Sheets[0].HorizontalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);
                    this.spdSpread.Sheets[0].VerticalGridLine = new FarPoint.Win.Spread.GridLine(FarPoint.Win.Spread.GridLineType.Flat, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, MPGV.gTheme.SpreadCellBorder, 1);

                    this.spdSpread.Sheets[0].SelectionBackColor = MPGV.gTheme.SpreadRowSelectedBackground;
                ...
                {
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ArrowColor = MPGV.gTheme.ControlCommonScrollBarArrowColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ArrowHoveredColor = MPGV.gTheme.ControlCommonScrollBarArrowColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ArrowSelectedColor = MPGV.gTheme.ControlCommonScrollBarArrowColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ButtonBackgroundColor = MPGV.gTheme.ControlCommonScrollBarForeground;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ButtonBorderColor = MPGV.gTheme.ControlCommonScrollBarForeground;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ButtonHoveredBackgroundColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ButtonHoveredBorderColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ButtonSelectedBackgroundColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).ButtonSelectedBorderColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).TrackBarBackgroundColor = MPGV.gTheme.ControlCommonScrollBarBackground;
                    ((EnhancedScrollBarRenderer)this.spdSpread.HorizontalScrollBar.Renderer).TrackBarSelectedBackgroundColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                }
                ...
                {
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ArrowColor = MPGV.gTheme.ControlCommonScrollBarArrowColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ArrowHoveredColor = MPGV.gTheme.ControlCommonScrollBarArrowColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ArrowSelectedColor = MPGV.gTheme.ControlCommonScrollBarArrowColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ButtonBackgroundColor = MPGV.gTheme.ControlCommonScrollBarForeground;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ButtonBorderColor = MPGV.gTheme.ControlCommonScrollBarForeground;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ButtonHoveredBackgroundColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ButtonHoveredBorderColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ButtonSelectedBackgroundColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).ButtonSelectedBorderColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).TrackBarBackgroundColor = MPGV.gTheme.ControlCommonScrollBarBackground;
                    ((EnhancedScrollBarRenderer)this.spdSpread.VerticalScrollBar.Renderer).TrackBarSelectedBackgroundColor = MPGV.gTheme.ControlCommonScrollBarSelectedColor;
                }
                ...
                {
                    ((EnhancedInterfaceRenderer)this.spdSpread.Skin.InterfaceRenderer).ScrollBoxBackgroundColor = MPGV.gTheme.SpreadBackground;
                    ((EnhancedInterfaceRenderer)this.spdSpread.Skin.InterfaceRenderer).SplitBoxBackgroundColor = MPGV.gTheme.ControlCommonScrollBarForeground;
                    ((EnhancedInterfaceRenderer)this.spdSpread.Skin.InterfaceRenderer).SplitBoxBorderColor = MPGV.gTheme.ControlCommonScrollBarForeground;
                    ((EnhancedInterfaceRenderer)this.spdSpread.Skin.InterfaceRenderer).SplitBarBackgroundColor = MPGV.gTheme.SpreadCellBorder;
                    ((EnhancedInterfaceRenderer)this.spdSpread.Skin.InterfaceRenderer).SplitBarDarkColor = MPGV.gTheme.SpreadCellBorder;
                    ((EnhancedInterfaceRenderer)this.spdSpread.Skin.InterfaceRenderer).SplitBarLightColor = MPGV.gTheme.SpreadCellBorder;
                }
            }
        }

        /// <summary>
        /// SetOITheme와 함께 기본 OI 레이아웃을 적용한다.
        /// </summary>
        public void SetFlexibleScreenForExcel()
        {
            try
            {
                if (this.spdSpread.Sheets.Count > 0)
                {
                    for (int i = this.spdSpread.Sheets.Count - 1; i > 0; i--)
                    {
                        this.spdSpread.Sheets.RemoveAt(i);
                    }
                ...
                if (this.spdSpread.Sheets.Count > 0)
                {
                    this.spdSpread.TabStripPolicy = TabStripPolicy.AsNeeded;
                }
            }
            catch (Exception ex)
            {
        ...
        private bool ScanScreen()
        {
            ...
            try
            {
                // screen_map 초기화
                mh_screen_map.Clear();
                mh_screen_dtmx_map.Clear();
                mh_screen_word_art_map.Clear();
                ...
                // FarPoint Word Art 개체에 대해
                if (spdSpread.ActiveSheet.DrawingContainer != null && spdSpread.ActiveSheet.DrawingContainer.Count > 0)
                {
                    FarPoint.Win.Spread.DrawingSpace.TextShape txtShape = null;
                    string s_word_art_key = string.Empty;
                    for (int iWordArt = spdSpread.ActiveSheet.DrawingContainer.Count-1; iWordArt >= 0; iWordArt--)
                    {
                        if(spdSpread.ActiveSheet.DrawingContainer.ContainedObjects[iWordArt] is FarPoint.Win.Spread.DrawingSpace.TextShape)
                        {
                            txtShape = (FarPoint.Win.Spread.DrawingSpace.TextShape)spdSpread.ActiveSheet.DrawingContainer.ContainedObjects[iWordArt];
                            if (string.IsNullOrEmpty(txtShape.Text) == false)
                            {
                                // Macro Rule : $
                                if (txtShape.Text.IndexOf("$") > -1)
                                {
                                    s_word_art_key = txtShape.Text.Replace('.', '/');
                                    s_word_art_key = s_word_art_key.Replace("$", "");
                                    s_word_art_key = s_word_art_key.Substring(s_word_art_key.LastIndexOfAny(c_delimiter) + 1);

                                    clsScreenTextShapeInfo textShapeInfo = new clsScreenTextShapeInfo();
                                    textShapeInfo.ObjectSeq = iWordArt;
                                    textShapeInfo.Object = (FarPoint.Win.Spread.DrawingSpace.TextShape)spdSpread.ActiveSheet.DrawingContainer.ContainedObjects[iWordArt];
                                    textShapeInfo.ObjectRect = new Rectangle(textShapeInfo.Object.Left, textShapeInfo.Object.Top, textShapeInfo.Object.Width, textShapeInfo.Object.Height);
                                    mh_screen_word_art_map.Add(s_word_art_key, textShapeInfo);
                                }
                            }
                            spdSpread.ActiveSheet.DrawingContainer.ContainedObjects.RemoveAt(iWordArt);  
                        }
                    }
                }
                ...
                for (i_row = spdSpread.ActiveSheet.RowCount - 1; i_row >= 0; i_row--)
                {
                    ...
                    {
                        b_dtmx = false;
                        s_value = string.Empty;
                        if (spdSpread.ActiveSheet.Cells[i_row, i_col].Tag != null)
                        {
                            // Get Cell DataMatrix Tag
                            s_value = spdSpread.ActiveSheet.Cells[i_row, i_col].Tag.ToString();
                            b_dtmx = true;
                        }
                        else
                        {
                        ...
                        // Macro Rule : @DTMX$= 또는 $=
                        if (s_value.IndexOf("@DTMX$=") > -1 || s_value.IndexOf("$=") > -1)
                        {
                            screen_info.MacroRule = clsScreenInfo.MACRO_RULE.COLUMN_RULE;
                        }
                        // Macro Rule : @DTMX$> 또는 $> 
                        else if (s_value.IndexOf("@DTMX$>") > -1 || s_value.IndexOf("$>") > -1)
                        {
                            screen_info.MacroRule = clsScreenInfo.MACRO_RULE.ROW_RULE;
                        }
                        // Macro Rule : @DTMX$MemberName@DTMX$ 또는 $MemberName$
                        else if ((s_value.StartsWith("@DTMX$") && s_value.EndsWith("@DTMX$")) 
                                    || (s_value.StartsWith("$") && s_value.EndsWith("$")))
                        {
                        ...
                        // Data Matrix Image Cell
                        else
                        {
                            screen_info.Path = s_value.Replace('.', '/');
                            screen_info.Path = screen_info.Path.Replace("@DTMX$", "");
                            screen_info.Path = screen_info.Path.Substring(screen_info.Path.LastIndexOfAny(c_delimiter) + 1);    //c_delimiter = {'=', '>', '.'}
                            screen_info.MemberName = s_value.Substring(s_value.LastIndexOfAny(c_delimiter) + 1);                //c_delimiter = {'=', '>', '.'}

                            // screen_map에 없는 경우
                            if (mh_screen_dtmx_map.Contains(screen_info.Path) == false)
                            {
                                // Cell Position 설정
                                screen_info.ValueCells.Add(new clsScreenInfo.Position(i_row, i_col));

                                // Add
                                mh_screen_dtmx_map.Add(screen_info.Path, screen_info);
                            }
                            else
                            {
                                // 동일 path 검색
                                clsScreenInfo item = (clsScreenInfo)mh_screen_dtmx_map[screen_info.Path];

                                // Position 추가
                                item.ValueCells.Add(new clsScreenInfo.Position(i_row, i_col));

                                // 교체
                                mh_screen_dtmx_map[screen_info.Path] = item;
                            }
        ...
        private bool LoadServiceMember()
        {
            ...
            try
            {
                ...
                do
                {
                    if (MPCF.CallService("SEC", "SEC_View_Flexible_Header_List", in_node, ref out_node) == false)
                    {
                        return false;
                    }
        ...
        private bool ViewScreenID()
        {
            ...
            try
            {
                ...
                if (MPCF.CallService("BAS", "BAS_Process_Flexible_Screen", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private bool ViewScreenID(string funcName)
        {
            ...
            try
            {
                ...
                in_node.AddString("TABLE_NAME", MPCF.Trim(MPGC.MP_GCM_BAS_SCREEN_REL));
                in_node.AddString("KEY_1", MPCF.Trim(funcName));
        ...
        /// <summary>
        ///  관계 설정을 탐색하여 Screen ID를 가져온다
        /// 찾고자하는 화면명(Func_name)과 print type으로 Screen ID를 MFO 설정에 따라 조회한다.
        /// </summary>
        /// <param name="funcName"></param>
        /// <param name="printType"></param>
        /// <returns></returns>
        private bool ViewScreenIDByMfo()
        {
            TRSNode in_node = new TRSNode("GET_SCREEN_ID_IN");
            TRSNode out_node = new TRSNode("GET_SCREEN_ID_OUT");
            ...
            try
            {
                ...
                in_node.AddString("RES_ID", ms_res_id);
                in_node.AddString("RESG_ID", ms_res_group);
                in_node.AddString("FUNC_NAME", ms_owner_func_name);
                in_node.AddString("PRINT_TYPE", ms_print_type);
                in_node.AddString("CUSTOMER", ms_customer_id);
                in_node.AddChar("REL_LEVEL", ms_rel_level);

                if (MPCF.CallService("BAS", "BAS_Get_Screen_Id", in_node, ref out_node) == false)
                {
                    return false;
                }

                if (string.IsNullOrEmpty(out_node.GetString("SCREEN_ID")) == false)
                {
                    ms_screen_id = out_node.GetString("SCREEN_ID");
                }
        ...
        /// <summary>
        /// Screen ID가 MFO 셋팅에 존재하는지 확인합니다.
        /// </summary>
        /// <param name="funcName"></param>
        /// <param name="printType"></param>
        ...
        /// <returns></returns>
        public string CheckScreenIDByMfo()
        {
            TRSNode in_node = new TRSNode("GET_SCREEN_ID_IN");
            TRSNode out_node = new TRSNode("GET_SCREEN_ID_OUT");
            ...
            try
            {
                ...
                in_node.AddString("FUNC_NAME", ms_owner_func_name);
                in_node.AddString("PRINT_TYPE", ms_print_type);
                in_node.AddString("CUSTOMER_ID", ms_customer_id);
                in_node.AddChar("REL_LEVEL", ms_rel_level);
                ...
                return out_node.GetString("SCREEN_ID");
            }
            catch (Exception ex)
            {
                MPCF.ShowMessage(ex.Message, CliFrx.MSG_LEVEL.ERROR, false);
        ...
        public bool LoadDesign()
        {
            try
            {
                if (ms_screen_id == null || ms_screen_id == "")
                {
                    ...
                    if (ms_screen_id == null || ms_screen_id == "")
                    {
                        // Screen ID를 찾을 수 없습니다. Flexible screen relation이나 Default screen ID를 확인 해 주십시요.
                        MPCF.ShowMessage(MPCF.GetMessage(313), CliFrx.MSG_LEVEL.ERROR, false);
                        return false;
                    }
                }
        ...
        /// <param name="oper"></param>
        /// <returns></returns>
        public bool LoadDesignByMfo()
        {
            try
            {
                if (ms_screen_id == null || ms_screen_id == "")
                {
                    // MFO에 설정된 FexibleScreenID가 있는지 확인
                    if (ViewScreenIDByMfo() == false)
                    {
                        return false;
                    }
        ...
        public bool SetServiceData(TRSNode in_node, ref TRSNode out_node, bool b_ignore_err)
        {
            try
            {
                ...
                // Call Service
                if (MPCF.CallService(ms_loaded_module_name, ms_loaded_service_name, in_node, ref out_node, b_ignore_err) == false)
                {
                    return false;
                }
        ...
        /// <summary>
        /// Set Data To Screen by Print Params
        /// </summary>
        /// <param name="xml"></param>
        /// <returns></returns>
        public bool SetDataToScreen(string xml)
        {
            TRSNode out_node = new TRSNode("SET_SCREEN_DATA_BIND_OUT");

            try
            {
                if (string.IsNullOrEmpty(xml) == false)
                {
                    TRSConvertorDefine.Convertor.Parse(out_node, xml);
                }
        ...
        public bool SetDataToScreen(TRSNode out_node)
        {
            try
            {
                ...
                // out_node 적용
                if (DataToScreen(out_node, FLEXIBLE_SCREEN_DATA_TYPE.WORD_ART) == false)
                {
                    return false;
                }
                if(DataToScreen(out_node, FLEXIBLE_SCREEN_DATA_TYPE.TEXT) == false)
                {
                    return false;
                }
                if(DataToScreen(out_node, FLEXIBLE_SCREEN_DATA_TYPE.DTMX) == false)
                {
                    return false;
                }
        ...
        /// <returns></returns>
        public bool DataToScreen(TRSNode out_node, FLEXIBLE_SCREEN_DATA_TYPE type)
        {
            int i, k;
            clsScreenInfo screen_info;
            VALUE_TAG value_info;
            List<TRSNode> list_items;
            Hashtable screen_map;
            Hashtable col_rule_screen_map;

            try
            {
                // 1) 대상 구분
                if (type == FLEXIBLE_SCREEN_DATA_TYPE.DTMX)
                {
                    screen_map = (Hashtable)mh_screen_dtmx_map.Clone();
                }
                else if (type == FLEXIBLE_SCREEN_DATA_TYPE.WORD_ART)
                {
                    screen_map = (Hashtable)mh_screen_word_art_map.Clone();
                }
                else
                {
                    screen_map = (Hashtable)mh_screen_map.Clone();
                }

                // 1.1) Work Art인 경우에 대한 처리 후 
                if (type == FLEXIBLE_SCREEN_DATA_TYPE.WORD_ART)
                {
                    foreach (string s_key_path in screen_map.Keys)
                    {
                        if (spdSpread.ActiveSheet.DrawingContainer != null)
                        {  
                            // 값
                            if (mh_data_map.Contains(s_key_path) == true)
                            {
                                ...
                                clsScreenTextShapeInfo textShapeInfo = (clsScreenTextShapeInfo)screen_map[s_key_path];
                                textShapeInfo.Object.Text = (string)value_info.Values[0];
                                textShapeInfo.Object.Left = textShapeInfo.ObjectRect.X;
                                textShapeInfo.Object.Top = textShapeInfo.ObjectRect.Y;
                                textShapeInfo.Object.Width = textShapeInfo.ObjectRect.Width;
                                textShapeInfo.Object.Height = textShapeInfo.ObjectRect.Height;
                                spdSpread.ActiveSheet.DrawingContainer.ContainedObjects.Add(textShapeInfo.Object);
                            }
                        }
                    }
                }                
                ...
                {
                    // 2) 대상 복사
                    col_rule_screen_map = (Hashtable)screen_map.Clone();

                    // Rule 적용이 필요한 Cell 만큼
                    foreach (string s_key_path in screen_map.Keys)
                    {
                        // 3) 복사대상 정보 추출
                        screen_info = (clsScreenInfo)screen_map[s_key_path];
                            ...
                            case clsScreenInfo.MACRO_RULE.NO_RULE:
                                if (mh_data_map.Contains(s_key_path) == true)
                                {
                                    ...
                                    for (i = 0; i < screen_info.ValueCells.Count; i++)
                                    {
                                        if (type == FLEXIBLE_SCREEN_DATA_TYPE.DTMX)
                                        {
                                            spdSpread.ActiveSheet.Cells[screen_info.ValueCells[i].Row, screen_info.ValueCells[i].Column].Value = EncodeDtmxImage((string)value_info.Values[0]);
                                        }
                                        else
                                        {
                                ...
                                if (mh_data_map.Contains(s_key_path) == true)
                                {
                                    ...
                                    for (i = 0; i < screen_info.ValueCells.Count; i++)
                                    {
                                        for (k = 0; k < value_info.Values.Count; k++)
                                        {
                                            ...
                                            if (type == FLEXIBLE_SCREEN_DATA_TYPE.DTMX)
                                            {
                                                spdSpread.ActiveSheet.Cells[screen_info.ValueCells[i].Row, screen_info.ValueCells[i].Column + k].Value = EncodeDtmxImage((string)value_info.Values[k]);
                                            }
                                            else
                                            {
                                                FillDatatoScreen(screen_info.ValueCells[i].Row,
                            ...
                            case clsScreenInfo.MACRO_RULE.FULL_RULE:
                                ...
                                for (i = 0; i < list_items.Count; i++)
                                {
                                    ...
                                    for (k = 0; k < list_items[i].MemberCount; k++)
                                    {
                                        ...
                                        if (type == FLEXIBLE_SCREEN_DATA_TYPE.DTMX)
                                        {
                                            spdSpread.ActiveSheet.Cells[screen_info.ValueCells[0].Row + i, screen_info.ValueCells[0].Column + k].Value = EncodeDtmxImage(list_items[i].GetMember(k).Value);
                                        }
                                        else
                                        {
                                            FillDatatoScreen(screen_info.ValueCells[0].Row + i,
                                                        screen_info.ValueCells[0].Column + k,
                                                        list_items[i].GetMember(k).Name,
                                                        list_items[i].GetMember(k).ValueType,
                                                        list_items[i].GetMember(k).Value);
                                        }
                                    }
                                }
                            ...
                            if (mh_data_map.Contains(s_key_path) == true)
                            {
                                ...
                                for (i = screen_info.ValueCells.Count - 1; i >= 0; i--)
                                {
                                    for (k = 0; k < value_info.Values.Count; k++)
                                    {
                                        ...
                                        if (type == FLEXIBLE_SCREEN_DATA_TYPE.DTMX)
                                        {
                                            spdSpread.ActiveSheet.Cells[screen_info.ValueCells[i].Row + k, screen_info.ValueCells[i].Column].Value = EncodeDtmxImage((string)value_info.Values[k]);
                                        }
                                        else
                                        {
                                            FillDatatoScreen(screen_info.ValueCells[i].Row + k,
                                                                screen_info.ValueCells[i].Column,
                                                                value_info.Name,
                                                                value_info.DataType,
                                                                (string)value_info.Values[k]);
                    ...
                    ms_print_params_xml = TRSConvertorDefine.Convertor.ToXmlString(out_node);
                }
        ...
        /// <summary>
        /// String value를 Data Matrix Encoding 합니다.
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        private Bitmap EncodeDtmxImage(string value)
        {
            ...
            return encoder.EncodeImage(value, options);
        }
        ...
        public void InitFlexibleScreen()
        {
            try
            {
                ...
                // Properties
                ms_previous_screen_id = string.Empty;
                ms_screen_id = string.Empty;
                ScreenAutoStretch = false;
                ScreenLock = false;
                ms_owner_func_name = string.Empty;
                mc_proc_step = '1';
                ms_lot_id = string.Empty;
                ms_mat_id = string.Empty;
                mi_mat_ver = 0;
                ms_flow = string.Empty;
                mi_flow_seq_num = 0;
                ms_oper = string.Empty;
                ms_res_id = string.Empty;
                ms_res_type = string.Empty;
                ms_res_group = string.Empty;
                ms_print_type = string.Empty;
                ms_customer_id = string.Empty;
                ms_rel_level = '1';
                ms_print_params_xml = string.Empty;
            }
            catch (Exception ex)
            {
                MPCF.ShowMsgBox(ex.Message);
    ...
    public sealed class clsScreenTextShapeInfo
    {
        public int ObjectSeq;
        public FarPoint.Win.Spread.DrawingSpace.TextShape Object;
        public Rectangle ObjectRect;
             
        public clsScreenTextShapeInfo()
        {
            this.ObjectSeq = 0;
            this.Object = null;
            this.ObjectRect = new Rectangle(0, 0, 0, 0);
        }
    }
}
