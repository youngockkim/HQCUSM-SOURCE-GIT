    ...
    public partial class SOIRadioButton : UltraOptionSet
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.Appearance.ForeColor = MPGV.gTheme.RadioButtonForeground;
                this.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                this.Appearance.BackColor = MPGV.gTheme.RadioButtonBackground;
                this.Appearance.BackColorDisabled = MPGV.gTheme.RadioButtonBackground;
