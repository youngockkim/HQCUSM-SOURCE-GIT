    ...
    public partial class SOICheckBox : UltraCheckEditor
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.Appearance.ForeColor = MPGV.gTheme.CheckBoxForeground;
                this.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                this.BackColor = MPGV.gTheme.CheckBoxBackground;
                this.Appearance.BackColorDisabled = MPGV.gTheme.CheckBoxBackground;
