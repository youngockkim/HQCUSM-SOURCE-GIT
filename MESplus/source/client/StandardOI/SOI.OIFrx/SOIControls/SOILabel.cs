    ...
    public partial class SOILabel : UltraLabel
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                {
                    this.Appearance.ForeColor = MPGV.gTheme.LabelForeground;
                }
                else if (_UseStyle == SOILabelStyle.KeyStyle)
                {
                    this.Appearance.ForeColor = MPGV.gTheme.LabelKeyForeground;
                }
                else if (_UseStyle == SOILabelStyle.ValueStyle)
                {
                    this.Appearance.ForeColor = MPGV.gTheme.LabelValueForeground;
                }

                // 색상
                this.Appearance.BackColor = MPGV.gTheme.LabelBackground;
            }
        }
