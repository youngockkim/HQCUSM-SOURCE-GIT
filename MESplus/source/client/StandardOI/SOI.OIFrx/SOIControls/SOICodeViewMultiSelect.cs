    ...
    public partial class SOICodeViewMultiSelect : UltraTextEditor
    {
            ...
            string listName, string[] displayColumn, string[] header, string[] visibleFalse, string selectedColumn, int pageSize)
        {
            ...
            try
            {
                ...
                // 초기화
                if (cvp.InitCodeViewPopup(control, popupTitle, moduleName, serviceName, inNode, listName, displayColumn, header, visibleFalse, selectedColumn, pageSize, returnValues, returnData) == false)
                {
                    return sReturn;
                }
