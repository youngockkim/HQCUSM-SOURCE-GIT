    ...
    public partial class SOITreeView : UltraTree
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 색상
                this.Appearance.BackColor = MPGV.gTheme.TreeViewBackground;                
                this.Appearance.ForeColor = MPGV.gTheme.TreeViewForeground;
                this.NodeConnectorColor = MPGV.gTheme.TreeViewLineForeground;
                this.Override.HotTrackingNodeAppearance.BackColor = MPGV.gTheme.TreeViewLineForeground;
                this.ScrollBarLook.ThumbAppearance.BackColor = MPGV.gTheme.TreeViewScrollThumbBackground;
            }
        }
