    ...
    public partial class frmPrintOptionPopup : frmPopupBase
    {
        ...
        private void frmPrintOptionPopup_Load(object sender, EventArgs e)
        {
            ...
            if (this.printOption == null)
            {
                ...
                if (MPCF.GetPrintOptionFromReg(ref this.printOption, this.funcName) == false)
                {
                    return;
                }
            }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.printOption.Label.BaudRate = MPCF.ToInt(cboLabelBaudRate.Text);
                this.printOption.Label.DataBit = MPCF.ToInt(cboLabelDataBit.Text);
                ...
                // 레지스트리 저장
                if (MPCF.SetPrintOptionToReg(this.printOption, this.funcName) == false)
                {
                    return;
                }
        ...
        private bool SetOption()
        {
            try
            {
                ...
                {
                    MPCF.ShowMessage(ex.Message, CliFrx.MSG_LEVEL.ERROR, true);
                }
                ...
                {
                    if (this.printOption.Label.BaudRate.Equals(MPCF.ToInt(cboLabelBaudRate.Items[i].DisplayText)))
                    {
                ...
                {
                    if (this.printOption.Label.DataBit.Equals(MPCF.ToInt(cboLabelDataBit.Items[i].DisplayText)))
                    {
