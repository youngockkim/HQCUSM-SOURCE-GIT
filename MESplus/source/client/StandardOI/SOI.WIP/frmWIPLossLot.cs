...
namespace SOI.WIP
{
    ...
    public partial class frmWIPLossLot : SOIBaseForm02
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void frmWIPLossLot_Load(object sender, EventArgs e)
        {
            // Init
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmWIPLossLot_Shown(object sender, EventArgs e)
        {
            // 최초 1회 실행
            if (bIsShown == false)
            {
