...
namespace SOI.WIP
{
    ...
    public partial class frmWIPViewLotStatusPopup : frmPopupBase
    {
        #region Property
        ...
        public frmWIPViewLotStatusPopup(string lotId)
        {
            InitializeComponent();
            txtLotID.Text = lotId;
        }
        ...
        /// <param name="e"></param>
        private void frmWIPViewLotStatusPopup_Load(object sender, EventArgs e)
        {
            // Caption 변경
