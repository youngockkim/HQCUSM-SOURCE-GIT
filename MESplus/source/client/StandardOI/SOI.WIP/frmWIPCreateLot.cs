...
namespace SOI.WIP
{
    ...
    public partial class frmWIPCreateLot : SOIBaseForm03
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void frmWIPCreateLot_Load(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmWIPCreateLot_Shown(object sender, EventArgs e)
        {
            // 최초 1회 실행
            if (bIsShown == false)
            {
        ...
        private void cdvWorkLine_CodeViewButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                ORDER = null;
                txtWorkOrder.Text = txtMaterial.Text = txtCustomer.Text = txtDueDate.Text = "";
                lblOrderQty.Text = lblInQty.Text = lblOutQty.Text = lblLossQty.Text = "";
                cdvInOper.Text = txtQty.Text = txtRunSheet.Text = txtLotID.Text = "";
        ...
        private void cdvWorkOrder_CodeViewButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                cdvWorkOrder.Code = cdvWorkOrder.Show(cdvWorkOrder, "View Work Order List", "ORD", "ORD_View_Order_List_Detail", in_node, "ORDER_LIST", display, header, "Order ID");
        ...
        private bool PrintRunsheet()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txtRunSheet.Text) == true)
                {
                    return true;
                }
