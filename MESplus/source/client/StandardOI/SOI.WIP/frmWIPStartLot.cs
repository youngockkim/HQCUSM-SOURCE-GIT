...
namespace SOI.WIP
{
    ...
    public partial class frmWIPStartLot : SOIBaseForm02
    {
        #region Property
        ...
        /// <param name="e"></param>        
        private void frmWIPStartLot_Load(object sender, EventArgs e)
        {
            // Init
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmWIPStartLot_Shown(object sender, EventArgs e)
        {
            // 최초 1회 실행
            if (bIsShown == false)
            {
