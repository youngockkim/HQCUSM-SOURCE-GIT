...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCMDMManageMeasurementEVAtoBacksheet : SOIBaseForm02
    {
        #region Property
        ...
        public frmCMDMManageMeasurementEVAtoBacksheet()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void frmCMDMManageMeasurementEVAtoBacksheet_Load(object sender, EventArgs e)
        {
            // Init
        ...
        private void frmCMDMManageMeasurementEVAtoBacksheet_Shown(object sender, EventArgs e)
        {
            if (bIsShown == false)
            {
        ...
        private void spdData_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            try
            {
                ...
                else if (e.Row >= 0 && e.Column == (int)LOT_LIST.TYPE_EVA_BACK_BTN) // Type of EVA Backside
                {
                    if (spdData.ActiveSheet.RowCount <= 0)
                        return;
                    ...
                    MPCF.SetInMsg(in_node);
                    in_node.ProcStep = '1'; // Alphabetical Order
                    in_node.AddString("TABLE_NAME", MPCF.Trim(HQGC.GCM_MD_TYPE_EVA_BACK));
                    in_node.AddString("KEY_1", "Type of EVA Backside");

                    string[] header = new string[] { "Code", "Description" };
                    string[] display = new string[] { "KEY_2", "DATA_1" };

                    cdvTypeEVABackside1.Text = cdvTypeEVABackside1.Show(cdvTypeEVABackside1, "Type of EVA Backside", "CBAS", "CBAS_View_Large_Data_List", in_node, "DATA_LIST", display, header, "KEY_2");

                    if (!string.IsNullOrEmpty(cdvTypeEVABackside1.Text))
                    {
                        spdData.ActiveSheet.Cells[e.Row, (int)LOT_LIST.COL_CHK].Value = true;
                        spdData.ActiveSheet.Cells[e.Row, (int)LOT_LIST.TYPE_EVA_BACK].Text = cdvTypeEVABackside1.Text;
                    }
                }
                else if (e.Row >= 0 && e.Column == (int)LOT_LIST.BACKSHEET_TYPE_BTN) // Type of Backsheet
                {
                    if (spdData.ActiveSheet.RowCount <= 0)
                        return;
                    ...
                    MPCF.SetInMsg(in_node);
                    in_node.ProcStep = '1'; // Alphabetical Order
                    in_node.AddString("TABLE_NAME", MPCF.Trim(HQGC.GCM_MD_TYPE_BACKSHEET));
                    in_node.AddString("KEY_1", "Type of Backsheet");

                    string[] header = new string[] { "Code", "Description" };
                    string[] display = new string[] { "KEY_2", "DATA_1" };

                    cdvBacksheetType1.Text = cdvBacksheetType1.Show(cdvBacksheetType1, "Type of Backsheet", "CBAS", "CBAS_View_Large_Data_List", in_node, "DATA_LIST", display, header, "KEY_2");

                    if (!string.IsNullOrEmpty(cdvBacksheetType1.Text))
                    {
                        spdData.ActiveSheet.Cells[e.Row, (int)LOT_LIST.COL_CHK].Value = true;
                        spdData.ActiveSheet.Cells[e.Row, (int)LOT_LIST.BACKSHEET_TYPE].Text = cdvBacksheetType1.Text;
                    }
                }
        ...
        private bool ViewData()
        {
            try
            {
                ...
                if (MPCF.CallService("CMDM", "CMDM_View_EVA_To_Backsheet_Data_List", in_node, ref out_node) == false)
                {
                    return false;
                }
                ...
                for (i = 0; i < out_node.GetList(0).Count; i++)
                {
                    ...
                    spdData.ActiveSheet.Cells[i, (int)LOT_LIST.TYPE_EVA_BACK].Value = lot_list.GetString("TYPE_EVA_BACK");
                    spdData.ActiveSheet.Cells[i, (int)LOT_LIST.GRN_NR_EVA_BACK].Value = lot_list.GetString("GRN_NR_EVA_BACK");
                    spdData.ActiveSheet.Cells[i, (int)LOT_LIST.BACKSHEET_TYPE].Value = lot_list.GetString("BACKSHEET_TYPE");
                    spdData.ActiveSheet.Cells[i, (int)LOT_LIST.GRN_NR_BACKSHEET].Value = lot_list.GetString("GRN_NR_BACKSHEET");
            ...
            try
            {
                ...
                for (i = 0; i < spdData.ActiveSheet.RowCount; i++)
                {
                    if (spdData.ActiveSheet.Cells[i, (int)LOT_LIST.COL_CHK].Value != null && Convert.ToBoolean(spdData.ActiveSheet.Cells[i, (int)LOT_LIST.COL_CHK].Value) == true)
                    {
                        ...
                        data_list.AddString("TYPE_EVA_BACK", MPCF.Trim(spdData.Sheets[0].Cells[i, (int)LOT_LIST.TYPE_EVA_BACK].Text));
                        data_list.AddString("GRN_NR_EVA_BACK", MPCF.Trim(spdData.Sheets[0].Cells[i, (int)LOT_LIST.GRN_NR_EVA_BACK].Text));
                        data_list.AddString("BACKSHEET_TYPE", MPCF.Trim(spdData.Sheets[0].Cells[i, (int)LOT_LIST.BACKSHEET_TYPE].Text));
                        data_list.AddString("GRN_NR_BACKSHEET", MPCF.Trim(spdData.Sheets[0].Cells[i, (int)LOT_LIST.GRN_NR_BACKSHEET].Text));
                ...
                if (MPCF.CallService("CMDM", "CMDM_Update_EVA_To_Backsheet_Data_List", in_node, ref out_node) == false)
                {
                    return false;
                }
