...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCWIPTerminateModulesMulti_V2 : SOIBaseForm02
    {
        #region Property
        ...
        public frmCWIPTerminateModulesMulti_V2()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void frmCWIPTerminateModulesMulti_V2_Load(object sender, EventArgs e)
        {
        ...
        private void frmCWIPTerminateModulesMulti_V2_Shown(object sender, EventArgs e)
        {
            if (bIsShown == false)
            {
//                MPCF.SetFocus(dtpFrom);
        ...
        private bool AddTerminatedLotList(TRSNode out_node)
        {
            ...
            try
            {
                ...
                if (out_node.GetString("LOT_CMF_16") == "N")
                {
        ...
        private bool TerminateLot(int row)
        {
            ...
            try
            {
                ...
                //}  
                if (cdvTerminateCode.Text == "P0101" || cdvTerminateCode.Text == "P0102")
                {
                    in_node.AddString("TRAN_CMF_16", "N");
                }
                else
