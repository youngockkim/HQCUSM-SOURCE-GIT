...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCUSManagePmppDiode : SOIBaseForm02
    {
        #region Property
        ...
        private bool ViewAlertList()
        {
            try
            {
                ...
                if (soiMachineIssueTypeCode != null && soiMachineIssueTypeCode.Text != "")
                {
                    in_node.AddString("MACHINE_ISSUE_TYPE", MPCF.Trim(soiMachineIssueTypeCode.Text));
                }
                else
                {
                ...
                for (int i = 0; i < out_node.GetList(0).Count; i++)
                {
                    ...
                    /*
                     ...
                     spdE10TroubleList.ActiveSheet.Cells[i, (int)FM_LIST.MODULE_ID].Value = MPCF.ToDate(out_node.GetList(0)[i].GetString("MODULE_ID"));
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MPCF.CheckValue(cdvMachineIssueTypeU, false) == false)
                {
                    return;
                }
        ...
        private bool Update_Pmpp_Diode_List()
        {
            ...
            try
            {
                ...
                {
                    //spdE10TroubleList.ActiveSheet.Cells[i, 1].Value
                    ...
                    if ((bool)spdE10TroubleList.Sheets[0].Cells[i, 1].Value == true)
                    {
                        ...
                        data_list.AddString("MACHINE_ISSUE_TYPE", MPCF.Trim(cdvMachineIssueTypeU.Text));
        ...
        /*
        private void spdE10TroubleList_EditChange(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            try
            {
                spdE10TroubleList.ActiveSheet.Cells[e.Row, (int)FM_LIST.COL_CHK].Value = true;
            }
            catch (Exception ex)
            {
                MPCF.ShowMsgBox(ex.Message);
