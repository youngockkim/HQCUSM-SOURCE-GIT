...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCUSModulePackingLabelZmdl : SOIBaseForm03
    {
        #region Property
        ...
        public frmCUSModulePackingLabelZmdl()
        {
            InitializeComponent();
        }
        ...
        private bool PackLotListAdd(string PalletID)
        {
            try
            {
                ...
                if (MPCF.CallService("CWIP", "CWIP_View_Packing_Label_Print_V2", in_node, ref out_node) == false)
                {
        ...
        {
            string reportID = "PackingPalletLabel_mod";
