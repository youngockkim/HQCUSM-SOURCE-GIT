...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCUSModuleRepairManagement : SOIBaseForm02
    {
        #region Property
        ...
        public frmCUSModuleRepairManagement()
        {
            InitializeComponent();
                    }
        ...
        private bool ViewLoss(string sLotId)
        {
            try
            {
                ...
                //m_strELImagePath = m_strELImagePath.Replace("\\\\10.60.0.100", "http://10.60.110.42").Replace("\\", "/");
