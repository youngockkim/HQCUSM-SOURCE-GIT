...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCUSModuleBacksheetBarcodeLabel  : SOIBaseForm03
    {
        #region Property
        ...
        public frmCUSModuleBacksheetBarcodeLabel ()
        {
            InitializeComponent();
        }
...
//            POWER,
        ...
        private bool ModuleListAdd(string ModuleID)
        {
            try
            {
                ...
                if (MPCF.CallService("CPOP", "CPOP_View_Label_Print_History", grade_in_node, ref grade_out_node) == false)
                {
                ...
                //spdList.ActiveSheet.Cells[0, (int)MODULE_LIST.POWER].Value = grade_out_node.GetString("POWER");
                spdList.ActiveSheet.Cells[0, (int)MODULE_LIST.LINE].Value = grade_out_node.GetString("LINE");
                spdList.ActiveSheet.Cells[0, (int)MODULE_LIST.ORDER].Value = grade_out_node.GetString("ORDER");
                spdList.ActiveSheet.Cells[0, (int)MODULE_LIST.START_TIME].Value = grade_out_node.GetString("START_TIME");
                spdList.ActiveSheet.Cells[0, (int)MODULE_LIST.QTY].Value = grade_out_node.GetInt("QTY");
                ...
                /*    
                lotId = grade_out_node.GetString("PRODUCT_NM");
                pmpp = grade_out_node.GetInt("PMPP").ToString();
                isc = grade_out_node.GetString("ISC");
                voc = grade_out_node.GetString("VOC");
                impp = grade_out_node.GetString("IMPP");
                vmpp = grade_out_node.GetString("VMPP");
                //vsys = grade_out_node.GetString("VSYS");
                kglbs = grade_out_node.GetString("WEIGHT");
               */
        ...
        private bool ProcPrint(TRSNode out_node, string moduleID)
        {
            try
            {
                ...
                */
                ...
                labelID = "SerialNoBacksheetLabel_mod";
                ...
                out_node.SetString("SERIAL_NO", moduleID);
                /*
        ...
        private void UpdatePrintHistory(string ModuleID)
        {
            try
            {
                ...
                in_node.ProcStep = '3'; /* Backsheet Label*/
