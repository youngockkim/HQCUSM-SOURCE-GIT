...
{
    public partial class frmCWIPEndLot : SOIBaseForm02
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void frmCWIPEndLot_Load(object sender, EventArgs e)
        {
            // Grid 초기화
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmCWIPEndLot_Shown(object sender, EventArgs e)
        {
            // 최초 1회 실행
            if (bIsShown == false)
            {
        ...
        private bool EndLot()
        {
            ...
            try
            {
                ...
                if (MPCF.CallService("WIP", "WIP_End_Lot", in_node, ref out_node) == false)
                {
                    return false;
                }
