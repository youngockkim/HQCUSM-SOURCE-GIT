...
namespace SOI.HanwhaQcell.USModule
{
    ...
    public partial class frmCUSModulePackingVertical : SOIBaseForm02
    {
        #region Property
        ...
        public frmCUSModulePackingVertical()
        {
            InitializeComponent();
        }
        ...
        */
        ...
        private bool ViewPackingLotInfo(string sLotID)
        {
            try
            {
                ...
                //txtArticleNo.Text = MPCF.Trim(out_node.GetString("ARTICLE_NO").ToString());
                //txtArticleDesc.Text = MPCF.Trim(out_node.GetString("ARTICLE_DESC").ToString());
                ...
                {
                    //BARCODE NUMBERING규칙변경 - ERP고도화(2023/04/17)
...
//                    txtPowerClass.Text = MPCF.Trim(out_node.GetString("POWER_CLASS").ToString()) + " " + MPCF.Trim(out_node.GetString("POWER").ToString());
                }
                else
                {
        ...
        private bool Tran_Pack_Lot_Input()
        {
            ...
            try
            {
                ...
                for (int k = spdLotList.ActiveSheet.RowCount - 1; k > -1; k--)
                {
                    ...
                    list_item.AddString("CMF_3", textRight(txtPackingID.Text, 3));
        ...
        private bool procprint()
        {
            ...
            try
            {
                ...
                {
                    for (int z = 0; z < 3; z++) // 3장 출력하기 수직포장 in Packing
        ...
        private void getPalletId()
        {
            ...
            if (cdvGrade.Text == "G03" || cdvGrade.Text == "G04" || cdvGrade.Text == "G01" || cdvGrade.Text == "B" || cdvGrade.Text == "G02") //--[G03/G04 로직 추가]
            {
