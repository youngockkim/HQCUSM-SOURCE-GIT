...
namespace BOI.WIPCus
{
    ...
    public partial class frmWIPTranManageWorkOrder : BOIBaseForm02
    {
        #region Property
        ...
        public frmWIPTranManageWorkOrder()
        {
            InitializeComponent();
        }
        ...
        {            
            try
            {
                if (CheckCondition("BUTTON_CLICK") == true)
                {
                    ...
                    {
                        BICF.OpenMenu(BIGC.MP_FUNC_NAME_CWIP8020, s_selected_order);
                        //frmWIPTranManageSelectWork frm = new frmWIPTranManageSelectWork(s_selected_order);
                        //frm.ShowDialog(this);
                    }
        ...
        private void frmWIPTranManageWorkOrder_FormClosing(object sender, FormClosingEventArgs e)
        {
