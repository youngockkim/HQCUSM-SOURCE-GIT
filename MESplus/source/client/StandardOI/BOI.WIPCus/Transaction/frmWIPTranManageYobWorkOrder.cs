...
namespace BOI.WIPCus
{
    ...
    public partial class frmWIPTranManageYobWorkOrder : BOIBaseForm02
    {
        #region Property
        ...
        public frmWIPTranManageYobWorkOrder()
        {
            InitializeComponent();
        }
        ...
        private bool ViewOrderList()
        {
            ...
            try
            {
                ...
                btnStartOrder.Enabled = true;
                btnStartOrder.Appearance.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(127)))), ((int)(((byte)(189)))));
                btnStartOrder.Appearance.BackColor2 = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(127)))), ((int)(((byte)(189)))));

                btnManualYob.Enabled = true;
                btnManualYob.Appearance.BackColor = btnStartOrder.Appearance.BackColor;
                btnManualYob.Appearance.BackColor2 = btnStartOrder.Appearance.BackColor2;
                ...
                {
                    btnStartOrder.Enabled = false;
                    btnStartOrder.Appearance.BackColor = SystemColors.Control;
                    btnStartOrder.Appearance.BackColor2 = SystemColors.Control;
                }

                if (MPCF.Trim(spdWorkOrder_Sheet1.Cells[0, (int)ORDER.ORD_STS].Tag) == BIGC.B_ORD_STATUS_COMPLETED)
                {
                    btnManualYob.Enabled = false;
                    btnManualYob.Appearance.BackColor = SystemColors.Control;
                    btnManualYob.Appearance.BackColor2 = SystemColors.Control;

                    btnEndOrder.Enabled = false;
                    btnEndOrder.Appearance.BackColor = SystemColors.Control;
                    btnEndOrder.Appearance.BackColor2 = SystemColors.Control;
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnProcessPacking_Click(object sender, EventArgs e)
        {
        ...
        private void btnSetResource_Click(object sender, EventArgs e)
        {
            try
            {
                if (MPCF.CheckValue(cdvLine, 1) == false)
                {
                    cdvLine.Focus();
                    return;
                }

                frmWIPAssignPackResource frm = new frmWIPAssignPackResource();
                frm.s_line_id = cdvLine.Tag.ToString();
                frm.ShowDialog(this);
            }
            catch (Exception ex)
            {
        ...
        private void btnSetResource_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                frmWIPSetupPackResource frm = new frmWIPSetupPackResource();
        ...
        private void btnPallet_Click(object sender, EventArgs e)
        {
            try
            {
                frmWIPMultiResultRegistration frm = new frmWIPMultiResultRegistration();
                frm.ShowDialog(this);
            }
            catch (Exception ex)
            {
