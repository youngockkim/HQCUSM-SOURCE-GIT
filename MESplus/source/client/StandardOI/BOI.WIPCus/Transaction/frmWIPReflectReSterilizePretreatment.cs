...
namespace BOI.WIPCus
{
    ...
    public partial class frmWIPReflectReSterilizePretreatment : BOIBaseForm02
    {
        #region Enum
        enum BOM
        {
        ...
        public frmWIPReflectReSterilizePretreatment()
        {
            InitializeComponent();
        }
        ...
        private void cdvOperID_CodeViewButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                // Show
                cdvOperID.Text = cdvOperID.Show(cdvOperID, "Oper", "COM0000-016", dvcArgu, display, header, "OPER_SHORT_DESC", -1);
        ...
        private void cdvTankId_CodeViewButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                BICF.ViewResource(cdvTankId, "", _lineId, MPCF.Trim(cdvOperID.Tag));
            }
            catch (Exception ex)
            {
                MPCF.ShowMessage(ex.Message, MSG_LEVEL.ERROR, false);
        ...
        private bool AssemblyLoadLot(string matId, string oper, string resID, string lotId)
        {
            ...
            try
            {
                ...
                in_node.AddChar("STERILIZE_FLAG", 'Y');
