...
{
    public partial class frmMaterialInputInForming : BOI.OIFrx.BOIBaseForm.BOIBaseForm02
    {
        public frmMaterialInputInForming()
        {
            InitializeComponent();
        }

        public frmMaterialInputInForming(string sOrder)
        {
            InitializeComponent();
            ViewOrder(sOrder);
        }
        ...
        private bool Create_Input_List(string sKind, char c_check)
        {
            ...
            try
            {
                ...
                dvcArgu[3].sCondition_Value = spdWorkOrder_Sheet1.Cells[i_row, (int)WRKORD.MAT_ID].Text;
        ...
        private bool ViewOrder(string sOrder)
        {
            ...
            try
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.ORDER_ID].Value = dt.Rows[i][1].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.ORDER_DATE].Value = MPCF.MakeDateFormat(dt.Rows[i][0].ToString(), DATE_TIME_FORMAT.DATE);
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.MAT_ID].Value = dt.Rows[i][2].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.MAT_DESC].Value = dt.Rows[i][3].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.BOM_TYPE].Value = dt.Rows[i][19].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.ORDER_QTY].Value = dt.Rows[i][4];
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.RES_ID].Value = dt.Rows[i][8].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.RES_ID].Tag = dt.Rows[i][13].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.LINE_ID].Value = dt.Rows[i][7].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.LINE_ID].Tag = dt.Rows[i][12].ToString();

                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.STATUS].Value = dt.Rows[i][11].ToString();
                    spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.STATUS].Tag = dt.Rows[i][17].ToString();
        ...
        private bool Input_Material(string sKind)
        {
            ...
            try
            {
                ...
                in_node.ProcStep = '1';
                in_node.AddString("RES_ID", spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.RES_ID].Tag);
                in_node.AddString("LINE_ID", spdWorkOrder_Sheet1.Cells[0, (int)WRKORD.LINE_ID].Tag);
        ...
        private bool Material_Reqirement_Calculation()
        {
            ...
            try
            {
                ...
                for (i = 0; i < spdWorkOrder_Sheet1.RowCount; i++)
                {
                    ...
                    for(i_row = 0; i_row < dt.Rows.Count; i_row++)
                    {
                        spdTargetMaterial_Sheet1.RowCount++;
                        spdTargetMaterial_Sheet1.Cells[i_row, (int)BOM.MAT_ID].Value = dt.Rows[i_row]["MAT_ID"];
                        spdTargetMaterial_Sheet1.Cells[i_row, (int)BOM.MAT_DESC].Value = dt.Rows[i_row]["MAT_DESC"];
                        spdTargetMaterial_Sheet1.Cells[i_row, (int)BOM.BOM_TYPE].Value = dt.Rows[i_row]["P_MAT_BOM_TYPE"];
                        spdTargetMaterial_Sheet1.Cells[i_row, (int)BOM.QTY].Value = dt.Rows[i_row]["REQ_QTY"];
                        spdTargetMaterial_Sheet1.Cells[i_row, (int)BOM.UNIT].Value = dt.Rows[i_row]["UNIT_1"];
                    }
                }
            }
            catch (System.Exception ex)
