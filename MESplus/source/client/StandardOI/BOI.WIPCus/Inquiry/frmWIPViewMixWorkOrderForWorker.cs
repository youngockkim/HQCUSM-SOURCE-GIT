...
namespace BOI.WIPCus
{
    ...
    public partial class frmWIPViewMixWorkOrderForWorker : BOIBaseForm02
    {
        #region Property
        ...
        public frmWIPViewMixWorkOrderForWorker()
        {
            InitializeComponent();
        }
        ...
        private bool ViewOrderList()
        {
            ...
            try
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    spdWorkOrder_Sheet1.Cells[i, (int)ORDER.LINE].Tag = dt.Rows[i]["LINE_ID"].ToString();
                    spdWorkOrder_Sheet1.Cells[i, (int)ORDER.LINE].Value = dt.Rows[i]["LINE_DESC"].ToString();
                    spdWorkOrder_Sheet1.Cells[i, (int)ORDER.RES].Tag = dt.Rows[i]["RES_ID"].ToString();
                    ...
                    spdWorkOrder_Sheet1.Cells[i, (int)ORDER.ORD_STS].Tag = dt.Rows[i]["ORDER_STATUS"].ToString();
                    spdWorkOrder_Sheet1.Cells[i, (int)ORDER.ORD_STS].Value = dt.Rows[i]["ORDER_STATUS_DESC"].ToString();
                }
        ...
        private void frmWIPViewMixWorkOrderForWorker_FormClosing(object sender, FormClosingEventArgs e)
        {
