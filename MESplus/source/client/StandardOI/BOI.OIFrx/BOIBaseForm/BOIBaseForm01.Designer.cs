namespace BOI.OIFrx.BOIBaseForm
{
    partial class BOIBaseForm01
    {
        ...
        private void InitializeComponent()
        {
			...
			// pnlMiddle
			// 
			this.pnlMiddle._SetAutoScrollPanel = false;
			...
			this.pnlMiddle.Size = new System.Drawing.Size(1274, 609);
			this.pnlMiddle.TabIndex = 3;
			// 
			// pnlMiddleMargin
			// 
			this.pnlMiddleMargin._SetAutoScrollPanel = false;
			...
			this.pnlMiddleMargin.Size = new System.Drawing.Size(1234, 599);
			this.pnlMiddleMargin.TabIndex = 2;
			// 
			// pnlBottom
			// 
			this.pnlBottom._SetAutoScrollPanel = false;
			this.pnlBottom._UseOITheme = false;
			this.pnlBottom._UseStyle = SOI.OIFrx.SOIPanelStyle.TransparentStyle;
			this.pnlBottom.BackColor = System.Drawing.Color.Transparent;
			this.pnlBottom.Controls.Add(this.pnlBottomMargin);
			...
			this.pnlBottom.Size = new System.Drawing.Size(1274, 50);
			this.pnlBottom.TabIndex = 2;
			// 
			// pnlBottomMargin
			// 
			this.pnlBottomMargin._SetAutoScrollPanel = false;
			...
			this.pnlBottomMargin.Location = new System.Drawing.Point(20, 5);
			this.pnlBottomMargin.Margin = new System.Windows.Forms.Padding(20, 5, 20, 5);
			this.pnlBottomMargin.Name = "pnlBottomMargin";
			this.pnlBottomMargin.Size = new System.Drawing.Size(1234, 40);
			this.pnlBottomMargin.TabIndex = 2;
			// 
			// pnlBottomClosePanel
			// 
			this.pnlBottomClosePanel._SetAutoScrollPanel = false;
			...
			this.pnlBottomClosePanel.Location = new System.Drawing.Point(1124, 0);
			...
			// pnlTop
			// 
			this.pnlTop._SetAutoScrollPanel = false;
			...
			// pnlTopMargin
			// 
			this.pnlTopMargin._SetAutoScrollPanel = false;
			...
			this.pnlTopMargin.Location = new System.Drawing.Point(35, 5);
			this.pnlTopMargin.Margin = new System.Windows.Forms.Padding(20, 5, 20, 5);
			this.pnlTopMargin.Name = "pnlTopMargin";
			this.pnlTopMargin.Size = new System.Drawing.Size(1219, 50);
			...
			this.lblFormTitle.Size = new System.Drawing.Size(1219, 50);
			...
			this.Name = "BOIBaseForm01";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "BOIBaseForm01";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.BOIBaseForm01_FormClosed);
			this.Load += new System.EventHandler(this.BOIBaseForm01_Load);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.BOIBaseForm01_KeyDown);
        ...
        public SOI.OIFrx.SOIControls.SOILabel lblFormTitle;
        public SOI.OIFrx.SOIControls.SOIButton btnClose;
        public SOI.OIFrx.SOIControls.SOIPanel pnlTopMargin;
        public SOI.OIFrx.SOIControls.SOIPanel pnlTop;
        public SOI.OIFrx.SOIControls.SOIPanel pnlBottom;
        public SOI.OIFrx.SOIControls.SOIPanel pnlBottomMargin;
        public SOI.OIFrx.SOIControls.SOIPanel pnlMiddleMargin;
        public SOI.OIFrx.SOIControls.SOIPanel pnlMiddle;
        public SOI.OIFrx.SOIControls.SOIPanel pnlBottomClosePanel;
    }
}