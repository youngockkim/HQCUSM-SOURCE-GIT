...
{
    public partial class BOIMatCodeView : UltraTextEditor
    {
        #region Property
        ...
        private bool bSaveRegistry = false;
        ...
        private BOI.OIFrx.BOIPopup.frmCodeViewPopup_Mat cvp;        
        ...
        public BOIMatCodeView()
        {
            InitializeComponent();
        }

        public BOIMatCodeView(IContainer container)
        {
            container.Add(this);
        ...
        private void BOIMatCodeView_Enter(object sender, EventArgs e)
        {
            bFocused = true;
            SetOITheme();
        }

        private void BOIMatCodeView_Leave(object sender, EventArgs e)
        {
            bFocused = false;
            SetOITheme();
        }

        private void BOIMatCodeView_MouseEnter(object sender, EventArgs e)
        {
            bMouseOver = true;
            SetOITheme();
        }

        private void BOIMatCodeView_MouseLeave(object sender, EventArgs e)
        {
            bMouseOver = false;
            SetOITheme();
        }

        private void BOIMatCodeView_TextChanged(object sender, EventArgs e)
        {
            if (DesignMode == true)
            {
                return;
        ...
        private void BOIMatCodeView_Click(object sender, EventArgs e)
        {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                {
                    this.ButtonsRight[0].Appearance.BackColor = MPGV.gTheme.CodeViewButtonBackground;
                }
        ...
        {
            bValidation = false;
            MPCF.ShowMessage("", SOI.CliFrx.MSG_LEVEL.NONE, false);
            SetOITheme();
        }
        ...
        /// <returns></returns>
        public string Show(BOIMatCodeView control, string popupTitle, string moduleName, string serviceName, TRSNode inNode,
            ...
            string listName, string[] displayColumn, string[] header, string selectedColumn, int pageSize)
        {
            ...
            try
            {
                ...
                // 신규 팝업 생성
                cvp = new BOI.OIFrx.BOIPopup.frmCodeViewPopup_Mat();
