...
namespace BOI.OIFrx.BOIPopup
{
    public partial class frmCodeViewPopup : frmPopupBase
    {
        ...
        /// <returns></returns>
        public bool InitCodeViewPopup(BOICodeView control, string popupTitle, string moduleName, string serviceName, TRSNode inNode,
        ...
        public bool InitCodeViewPopup(BOICodeView control, string popupTitle, string ViewID, TPDR.DirectViewCond[] cvcArgu,
        ...
        private bool ViewService()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //if (cvpm.IsDirectView)
                    //{
                    //    if (BICF.ViewDynaimcQuery("", ref dt, cvpm.ViewID, cvpm.Argu, false, false, ref sSql) == false)
                    //    {
                    //        if (dt != null)
                    //            dt.Dispose();
                    ...
                    if (cvpm.Header == null)
                    {
                        ...
                        {
                            cboFind.Items.Add(dt.Columns[i].ColumnName.Replace(' ', '_'), MPCF.FindLanguage(dt.Columns[i].ColumnName));
        ...
        private int GetIndexDisplayColumn(string columnName)
        {
            ...
            if (cvpm.DisplayColumn == null)
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "COM0000-002", dvcArug, false, false, ref s_sql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
    ...
    {
        private BOICodeView _control;
        public BOICodeView Control
        {
            get { return _control; }
            set { _control = value; }
        }
        ...
        private bool _isDirectView;

        public bool IsDirectView
        {
          get { return _isDirectView; }
          set { _isDirectView = value; }
        }
    }
}
