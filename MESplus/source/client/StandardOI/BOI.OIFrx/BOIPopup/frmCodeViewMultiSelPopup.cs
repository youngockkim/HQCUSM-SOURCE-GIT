...
{
    public partial class frmCodeViewMultiSelPopup : frmPopupBase
    {
        #region Property
        ...
        private CodeViewMultiPopupModel cvpm;        
        ...
        public frmCodeViewMultiSelPopup()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void frmCodeViewMultiSelPopup_Load(object sender, EventArgs e)
        {
            // Title 변경
        ...
        /// <summary>
        /// Grid에서 멀티선택 후 선택된 값을 Return 한다.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnSelect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < gridCodeViewPopup.Rows.Count; i++)
                {
                    if ((bool)gridCodeViewPopup.Rows[i].Cells[0].Value == true)
                    {
                        Datas = new List<string>();
                        for (int j = 0; j < gridCodeViewPopup.Rows[i].Cells.Count; j++)
                        {
                            Datas.Add(gridCodeViewPopup.Rows[i].Cells[j].Text);
                        }
            ...
            string listName, string[] displayColumn, string[] header, string selectedColumn, int pageSize)
        {
            ...
            if (cvpm == null)
            {
                cvpm = new CodeViewMultiPopupModel();
            }
    ...
    public class CodeViewMultiPopupModel
    {
