    ...
    public sealed class FtpClient
    {
        ...
        public void Login()
        {
            ...
            try
            {
                ...
                // this.clientSocket.Connect(ep); 를 아래로 변경 (설정된 FTP IP, PORT를 사용해서 connect)
        ...
        private Socket createDataSocket()
        {
            ...
            try
            {
                ...
                //  socket.Connect(ep); 를 아래로 변경 (설정된 FTP IP, PORT를 사용해서 connect)
