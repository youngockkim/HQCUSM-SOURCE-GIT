...
namespace SOI.Solar
{
    public partial class frmCUSTranPackingLot : BOI.OIFrx.BOIBaseForm.BOIBaseForm02
    {
        #region [Property]
        ...
        private void frmCUSTranPackingLot_Load(object sender, EventArgs e)
        {
            MPCF.ClearList(spdLotList);
        ...
        private void frmCUSTranPackingLot_Activated(object sender, EventArgs e)
        {

        }

        private void frmCUSTranPackingLot_Shown(object sender, EventArgs e)
        {
            if (bIsShown == false)
            {
                bIsShown = true;
