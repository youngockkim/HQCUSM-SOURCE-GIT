...
namespace BOI.INVCus
{
    ...
    public partial class frmINVOutInventoryLotInfo : BOIBaseForm02
    {
        #region Property
        ...
        public frmINVOutInventoryLotInfo()
        {
            InitializeComponent();
        }

        public frmINVOutInventoryLotInfo(string args)
        {
            InitializeComponent();
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                file_path = "";
                frmInvViewInvDispense frm = new frmInvViewInvDispense(MPCF.Trim(_sInvReqNo));
                selectedMenuInfo = new MenuInfoTag();
                selectedMenuInfo.s_func_desc = "View Inv Dispense";
        ...
        private bool View_Req_Mst(string reqFromDate, string reqToDate, string invReqNo)
        {
            try
            {
                ...
                if (TPDR.GetDataOne(s_column, ref dt, "CINV2212-001", dvcArgu, false, false) == false)
                {
                    if (dt != null)
                        dt.Dispose();
