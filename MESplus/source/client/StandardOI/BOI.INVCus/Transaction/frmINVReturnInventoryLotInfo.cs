...
namespace BOI.INVCus
{
    ...
    public partial class frmINVReturnInventoryLotInfo : BOIBaseForm02
    {
        #region Property
        ...
        public frmINVReturnInventoryLotInfo()
        {
            InitializeComponent();
        }

        public frmINVReturnInventoryLotInfo(string args)
        {
            InitializeComponent();
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                if (CheckCondition("RETURN_LOT") == true)
                {
                    if (Return_Lot('2') == true)
                    {
                        btnView.PerformClick();
                    }
                }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                file_path = "";
                frmInvViewInvReturn frm = new frmInvViewInvReturn(MPCF.Trim(_sInvReqNo));
        ...
        private bool View_Req_Mst(string reqFromDate, string reqToDate, string invReqNo)
        {
            try
            {
                ...
                dvcArgu[1].sCondition_Value = BIGC.B_REQ_TYPE_RETURN;
                ...
                if (TPDR.GetDataOne(s_column, ref dt, "CINV2213-001", dvcArgu, false, false) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Req_Detail(string sInvReqNo, char cReqStatus)
        {
            try
            {
                ...
                if (TPDR.GetDataOne(s_column, ref dt, "CINV2213-002", dvcArgu, false, false) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Picking_Lot(string sMatId, int iInvReqSeq)
        {
            try
            {
                ...
                if (TPDR.GetDataOne(s_column, ref dt, "CINV2213-003", dvcArgu, false, false) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        //
        private bool Return_Lot(char ProcStep)
        {
            TRSNode in_node = new TRSNode("RETURN_LOT_IN");
            TRSNode out_node = new TRSNode("RETURN_LOT_OUT");
            ...
            try
            {
                ...
                //INV_CMF_2 계정상세유형 
                in_node.AddString("LOT_CMF_2", BIGC.B_INV_ACC_DETAIL_MOVE_RETURN);
