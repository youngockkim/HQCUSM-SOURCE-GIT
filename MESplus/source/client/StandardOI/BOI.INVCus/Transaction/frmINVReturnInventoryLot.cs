...
namespace BOI.INVCus
{
    ...
    public partial class frmINVReturnInventoryLot : BOIBaseForm02
    {
        #region Property
        ...
        public frmINVReturnInventoryLot()
        {
            InitializeComponent();
        }

        public frmINVReturnInventoryLot(string args)
        {
            InitializeComponent();
        ...
        private bool View_Req_Mst(string reqDate, string invReqNo)
        {
            try
            {
                ...
                if (invReqNo == "")
                {
                    ...
                    if (TPDR.GetDataOne(s_column, ref dt, "CINV2213-005", dvcArgu, false, false) == false)
                    {
                        if (dt != null)
                            dt.Dispose();
                ...
                else
                {
                    ...
                    if (TPDR.GetDataOne(s_column, ref dt, "CINV2213-004", dvcArgu, false, false) == false)
                    {
                        if (dt != null)
                            dt.Dispose();
