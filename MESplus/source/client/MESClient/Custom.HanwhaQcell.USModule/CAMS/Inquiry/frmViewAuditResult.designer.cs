...
{
    partial class frmViewAuditResult
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.panel2.Size = new System.Drawing.Size(742, 435);
            ...
            this.spdAuditList.FocusRenderer = defaultFocusIndicatorRenderer1;
            ...
            this.spdAuditList.HorizontalScrollBar.Renderer = defaultScrollBarRenderer1;
            this.spdAuditList.HorizontalScrollBar.TabIndex = 72;
            ...
            this.spdAuditList.Size = new System.Drawing.Size(742, 435);
            ...
            this.spdAuditList.VerticalScrollBar.Renderer = defaultScrollBarRenderer2;
            this.spdAuditList.VerticalScrollBar.TabIndex = 73;
            this.spdAuditList.VerticalScrollBarPolicy = FarPoint.Win.Spread.ScrollBarPolicy.AsNeeded;
            this.spdAuditList.VisualStyles = FarPoint.Win.VisualStyles.Off;
            this.spdAuditList.CellDoubleClick += new FarPoint.Win.Spread.CellClickEventHandler(this.spdAuditList_CellDoubleClick);
            this.spdAuditList.SetViewportLeftColumn(0, 0, 3);
            ...
            spdAuditList_Sheet1.ColumnCount = 28;
            spdAuditList_Sheet1.ColumnHeader.RowCount = 2;
            ...
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 0).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "Audit ID";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 1).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "Description";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 2).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "Plan Date";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 3).ColumnSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 3).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "Customer";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "Customer Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 5).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "Auditor";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 6).ColumnSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 6).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "Manager";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "Manager Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 8).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "Agenda";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 9).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "Audit Date";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 10).ColumnSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 10).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "Status";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "Status Desc";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 12).RowSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "Document";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 13).ColumnSpan = 9;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "Audit Item";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "Create User";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "Item Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "Detial";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 19).Value = "Result";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 20).Value = "File Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 22).ColumnSpan = 6;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 22).Value = "Audit Action";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 13).ColumnSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 13).Value = "Division";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 15).Value = "Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 16).Value = "Detail";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 17).Value = "Finding";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 18).Value = "File Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 19).ColumnSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 19).Value = " Person In Charge";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 21).Value = "Limit Date";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 22).Value = "Action Date";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 23).ColumnSpan = 2;
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 23).Value = "Person In Charge";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 25).Value = "Result";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 26).Value = "File Name";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(1, 27).Value = "Remark";
            ...
            this.spdAuditList_Sheet1.Columns.Get(0).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(0).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(0).Width = 100F;
            this.spdAuditList_Sheet1.Columns.Get(1).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdAuditList_Sheet1.Columns.Get(1).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(1).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(1).Width = 150F;
            ...
            this.spdAuditList_Sheet1.Columns.Get(3).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ...
            this.spdAuditList_Sheet1.Columns.Get(3).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(4).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            ...
            this.spdAuditList_Sheet1.Columns.Get(4).Width = 145F;
            this.spdAuditList_Sheet1.Columns.Get(5).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            ...
            this.spdAuditList_Sheet1.Columns.Get(5).Width = 161F;
            ...
            this.spdAuditList_Sheet1.Columns.Get(6).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(7).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            ...
            this.spdAuditList_Sheet1.Columns.Get(7).Width = 144F;
            this.spdAuditList_Sheet1.Columns.Get(8).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            ...
            this.spdAuditList_Sheet1.Columns.Get(8).Width = 300F;
            this.spdAuditList_Sheet1.Columns.Get(9).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(9).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(9).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(9).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(10).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(10).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(10).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(10).Width = 37F;
            this.spdAuditList_Sheet1.Columns.Get(11).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdAuditList_Sheet1.Columns.Get(11).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(11).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(11).Width = 148F;
            this.spdAuditList_Sheet1.Columns.Get(12).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(12).Width = 120F;
            this.spdAuditList_Sheet1.Columns.Get(13).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(13).Label = "Division";
            this.spdAuditList_Sheet1.Columns.Get(13).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(13).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(14).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(14).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(14).Width = 123F;
            this.spdAuditList_Sheet1.Columns.Get(15).Label = "Name";
            this.spdAuditList_Sheet1.Columns.Get(15).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(15).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(15).Width = 140F;
            this.spdAuditList_Sheet1.Columns.Get(16).Label = "Detail";
            this.spdAuditList_Sheet1.Columns.Get(16).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(16).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(16).Width = 180F;
            this.spdAuditList_Sheet1.Columns.Get(17).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(17).Label = "Finding";
            this.spdAuditList_Sheet1.Columns.Get(17).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(17).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(17).Width = 70F;
            this.spdAuditList_Sheet1.Columns.Get(18).Label = "File Name";
            this.spdAuditList_Sheet1.Columns.Get(18).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(18).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(18).Width = 130F;
            this.spdAuditList_Sheet1.Columns.Get(19).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(19).Label = " Person In Charge";
            this.spdAuditList_Sheet1.Columns.Get(19).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(19).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(20).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(20).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(20).Width = 122F;
            this.spdAuditList_Sheet1.Columns.Get(21).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(21).Label = "Limit Date";
            this.spdAuditList_Sheet1.Columns.Get(21).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(21).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(21).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(22).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(22).Label = "Action Date";
            this.spdAuditList_Sheet1.Columns.Get(22).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(22).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(22).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(23).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(23).Label = "Person In Charge";
            this.spdAuditList_Sheet1.Columns.Get(23).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(23).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(24).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(24).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(24).Width = 120F;
            this.spdAuditList_Sheet1.Columns.Get(25).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(25).Label = "Result";
            this.spdAuditList_Sheet1.Columns.Get(25).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(25).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(25).Width = 61F;
            this.spdAuditList_Sheet1.Columns.Get(26).Label = "File Name";
            this.spdAuditList_Sheet1.Columns.Get(26).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(26).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(26).Width = 130F;
            this.spdAuditList_Sheet1.Columns.Get(27).Label = "Remark";
            this.spdAuditList_Sheet1.Columns.Get(27).Locked = true;
            this.spdAuditList_Sheet1.Columns.Get(27).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(27).Width = 150F;
            this.spdAuditList_Sheet1.FrozenColumnCount = 3;
            ...
            this.Name = "frmViewAuditResult";
            this.Text = "View Audit History";
            this.Activated += new System.EventHandler(this.frmViewAuditResult_Activated);
