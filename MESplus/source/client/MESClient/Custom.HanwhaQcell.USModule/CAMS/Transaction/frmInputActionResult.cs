...
//
//   System      : MESClient
//   File Name   : frmInputActionResult.cs
//   Description : 
//
...
{
    public partial class frmInputActionResult : ViewForm01
    {
        public frmInputActionResult()
        {
            InitializeComponent();
        }
        ...
        //       -
        //
        private bool ViewAuditResultList()
        {
            ...
            try
            {
                ...
                do
                {
                    TRSNode out_node = new TRSNode("CAMS_VIEW_AUDIT_RESULT_LIST_OUT");

                    if (MPCR.CallService("CAMS", "CAMS_View_Audit_Result_List", in_node, ref out_node) == false)
                    {
                        return false;
                    }
                ...
                {
                    List<TRSNode> audit_result_list = out_node.GetList("AUDIT_RESULT_LIST");
                    foreach (TRSNode node in audit_result_list)
                    {
                        ...
                        with_1.SetValue(i, MPCF.ToInt(PLAN_LIST.AUDIT_DATE), MPCF.MakeDateFormat(node.GetString("AUDIT_DATE"), DATE_TIME_FORMAT.DATE));
        ...
        private bool OpenAuditResultPopup(string s_audit_id)
        {
            try
            {
                frmInputActionResultPopup _resultPopup = new frmInputActionResultPopup();
        ...
        private void frmInputActionResult_Activated(object sender, System.EventArgs e)
        {
        ...
        private void btnView_Click(System.Object sender, System.EventArgs e)
        {
            ...
            if (ViewAuditResultList() == false) return;
        }
