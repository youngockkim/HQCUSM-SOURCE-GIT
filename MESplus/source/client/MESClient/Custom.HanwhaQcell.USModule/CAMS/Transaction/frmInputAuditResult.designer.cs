...
{
    partial class frmInputAuditResult
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.spdAuditList.HorizontalScrollBar.TabIndex = 42;
            ...
            this.spdAuditList.VerticalScrollBar.TabIndex = 43;
            ...
            spdAuditList_Sheet1.ColumnCount = 15;
            spdAuditList_Sheet1.RowCount = 2;
            this.spdAuditList_Sheet1.Cells.Get(0, 0).Value = 0;
            ...
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "Detail";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "Audit ID";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "Audit Description";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "Plan Date";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "Customer Code";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "Customer";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "Auditor";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "Manager ID";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "Manager";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "Status Code";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "Status";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "Create Time";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "Create User";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "Update Time";
            this.spdAuditList_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "Update User";
            ...
            this.spdAuditList_Sheet1.Columns.Get(0).CellType = buttonCellType1;
            this.spdAuditList_Sheet1.Columns.Get(0).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(0).Label = "Detail";
            ...
            this.spdAuditList_Sheet1.Columns.Get(1).Label = "Audit ID";
            ...
            this.spdAuditList_Sheet1.Columns.Get(1).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(2).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdAuditList_Sheet1.Columns.Get(2).Label = "Audit Description";
            ...
            this.spdAuditList_Sheet1.Columns.Get(4).Visible = false;
            this.spdAuditList_Sheet1.Columns.Get(4).Width = 0F;
            this.spdAuditList_Sheet1.Columns.Get(5).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(5).Label = "Customer";
            ...
            this.spdAuditList_Sheet1.Columns.Get(7).Visible = false;
            this.spdAuditList_Sheet1.Columns.Get(7).Width = 0F;
            this.spdAuditList_Sheet1.Columns.Get(8).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(8).Label = "Manager";
            this.spdAuditList_Sheet1.Columns.Get(8).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(8).Width = 100F;
            this.spdAuditList_Sheet1.Columns.Get(9).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(9).Label = "Status Code";
            this.spdAuditList_Sheet1.Columns.Get(9).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(9).Visible = false;
            this.spdAuditList_Sheet1.Columns.Get(9).Width = 0F;
            this.spdAuditList_Sheet1.Columns.Get(10).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(10).Label = "Status";
            this.spdAuditList_Sheet1.Columns.Get(10).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdAuditList_Sheet1.Columns.Get(10).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(11).Label = "Create Time";
            this.spdAuditList_Sheet1.Columns.Get(11).Width = 100F;
            this.spdAuditList_Sheet1.Columns.Get(12).Label = "Create User";
            this.spdAuditList_Sheet1.Columns.Get(12).Width = 80F;
            this.spdAuditList_Sheet1.Columns.Get(13).Label = "Update Time";
            this.spdAuditList_Sheet1.Columns.Get(13).Width = 100F;
            this.spdAuditList_Sheet1.Columns.Get(14).Label = "Update User";
            this.spdAuditList_Sheet1.Columns.Get(14).Width = 80F;
            ...
            this.Name = "frmInputAuditResult";
            this.Text = "Input Audit Result";
            this.Activated += new System.EventHandler(this.frmInputAuditResult_Activated);
