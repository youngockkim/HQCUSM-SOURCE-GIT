...
{
    public partial class frmMMSVariablesAnalysis : ViewForm01    {
        public frmMMSVariablesAnalysis()
        {
            InitializeComponent();
            c_ana_div = '0';
        ...
        private void frmMMSVariablesAnalysis_Activated(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                switch (e.Column)
                {
                    case (int)LIST.DETAIL:
                        frmMMSVariablesAnalysisPopup _resultPopup = new frmMMSVariablesAnalysisPopup();
