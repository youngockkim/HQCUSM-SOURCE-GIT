...
//
//   System      : MESClient
//   File Name   : frmMMSVariablesAnalysis.cs
//   Description : 
//
...
{
    public partial class frmMMSLinearityAnalysis : ViewForm01    {
        public frmMMSLinearityAnalysis()
        {
            InitializeComponent();
            c_ana_div = '3';
        ...
        //
        // CMMSViewAnalysisPlanResultList()
            ...
            try
            {
                ...
                foreach(TRSNode out_node in out_list)
                {
                    ...
                    foreach (TRSNode node in analysis_plan_result_list)
                    {
                        ...
                        with_1.SetValue(i, MPCF.ToInt(LIST.ANA_RESULT), (node.GetChar("ANA_RESULT") == 'P' ? "Pass" : "Fail"));
        ...
        private void frmMMSLinearityAnalysis_Activated(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                switch (e.Column)
                {
                    case (int)LIST.DETAIL:
                        frmMMSLinearityAnalysisPopup _resultPopup = new frmMMSLinearityAnalysisPopup();
