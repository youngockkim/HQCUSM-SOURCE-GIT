...
//
//   System      : MESClient
//   File Name   : frmMMSBiasAnalysis.cs
//   Description : 
//
...
{
    public partial class frmMMSBiasAnalysis : ViewForm01    {
        public frmMMSBiasAnalysis()
        {
            InitializeComponent();
            c_ana_div = '2';
        ...
        private void frmMMSBiasAnalysis_Activated(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                switch (e.Column)
                {
                    case (int)LIST.DETAIL:
                        frmMMSBiasAnalysisPopup _resultPopup = new frmMMSBiasAnalysisPopup();
