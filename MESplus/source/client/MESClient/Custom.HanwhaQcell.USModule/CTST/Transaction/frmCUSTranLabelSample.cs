...
{
    public partial class frmCUSTranLabelSample : Miracom.MESCore.ViewForm01
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            s_lot_id = MPCF.Trim(uteLotID.Text);
            if (s_lot_id == "") 
                return ;
            ...
            if (out_node.GetString("CHILD_LOT_ID") == "")
            {
                ...
                out_node.SetString("LOT_CMF_6", MPCF.Trim(uteLotID.Text));
