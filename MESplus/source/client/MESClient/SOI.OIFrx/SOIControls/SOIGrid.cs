    ...
    public partial class SOIGrid : UltraGrid
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 색상
                this.DisplayLayout.Appearance.BackColor = MOGV.gTheme.GridBackground;
                this.DisplayLayout.Appearance.BorderColor = MOGV.gTheme.GridBorder;                                   
                ...
                this.DisplayLayout.Override.CellAppearance.BackColor = MOGV.gTheme.GridBackground;
                this.DisplayLayout.Override.CellAppearance.BorderColor = MOGV.gTheme.GridCellBorder;
                this.DisplayLayout.Override.CellAppearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                this.DisplayLayout.Override.CellAppearance.ForeColor = MOGV.gTheme.GridCellForeground;
                this.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.Standard;                
                this.DisplayLayout.Override.HeaderAppearance.BackColor = MOGV.gTheme.GridColumnHeaderBackground;
                this.DisplayLayout.Override.HeaderAppearance.BackColor2 = MOGV.gTheme.GridColumnHeaderBackground;
                this.DisplayLayout.Override.HeaderAppearance.BorderColor = MOGV.gTheme.GridBorder;
                this.DisplayLayout.Override.HeaderAppearance.BorderColor2 = MOGV.gTheme.GridBorder;
                this.DisplayLayout.Override.HeaderAppearance.ForeColor = MOGV.gTheme.GridColumnHeaderForeground;
                this.DisplayLayout.Override.HeaderAppearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;                
                this.DisplayLayout.Override.RowAppearance.BorderColor = MOGV.gTheme.GridCellBorder;
                this.DisplayLayout.DefaultSelectedBackColor = MOGV.gTheme.GridRowSelectedBackground;
                this.DisplayLayout.DefaultSelectedForeColor = MOGV.gTheme.GridCellForeground;
        ...
        public UltraGridColumn AddColumn(string key, string header)
        {
            try
            {
                ...
                // Display Column Add
                UltraGridColumn ugc = this.DisplayLayout.Bands[0].Columns.Add(key, MPOF.FindLanguage(header));
