...
namespace SOI.OIFrx.SOIControls
{
    public partial class SOICodeViewDescription : UserControl
    {
        ...
        private bool _useAutoSize = true; // 최초 컨트롤 Add시 Default로 테마 적용
        public bool _UseAudtoSize
        {
            get
            {
                return _useAutoSize;
            ...
            {
                _useAutoSize = value;
                this.cdvCode.AutoSize = _useAutoSize;
                this.txtDesc.AutoSize = _useAutoSize;
                //this.cdvCode.Dock = DockStyle.Fill;
            }
        }
        ...
        public int CodeHeight
        {
            ...
            {
                codeHeight = value;
                this.cdvCode.Height = codeHeight;
                this.txtDesc.Height = codeHeight;
            }
        }
       ...
       // private frmCodeViewPopup cvp;
            ...
            string listName, string[] displayColumn, string[] header, string selectedColumn, int pageSize)
        {
            ...
            {
                // Code Return
                sReturn = this.cdvCode.Show(cdvCode, popupTitle, moduleName, serviceName, inNode, listName, displayColumn, header, selectedColumn, pageSize);
        ...
        /// <param name="selectedColumn"></param>
        /// <returns></returns>
        public string Show(SOICodeViewDescription control, string popupTitle, string queryID, string[] queryArgument,
            ...
            string[] displayColumn, string[] header, string selectedColumn, int pageSize)
        {
            ...
            {
                // 리턴값 초기화
                sReturn = this.cdvCode.Show(cdvCode, popupTitle, queryID, queryArgument, displayColumn, header, selectedColumn);
                ...
                else if (string.IsNullOrEmpty(this.Description) == true || this.drResult.ToString() == "No")
                {
                    this.Description = string.Empty;
                }
                //else
