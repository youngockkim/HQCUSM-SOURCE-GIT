    ...
    public partial class SOICheckBoxOnOff : UserControl
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.pnlOutBorder.BackColor = MOGV.gTheme.CheckBoxOnOffBorder;
                this.lblOnText.Appearance.BackColor = MOGV.gTheme.CheckBoxOnOffOnBackground;
                this.lblOnText.Appearance.ForeColor = MOGV.gTheme.CheckBoxOnOffOnForeground;
                this.lblOffText.Appearance.BackColor = MOGV.gTheme.CheckBoxOnOffOffBackground;
                this.lblOffText.Appearance.ForeColor = MOGV.gTheme.CheckBoxOnOffOffForeground;
                this.btnOff.Appearance.BackColor = MOGV.gTheme.CheckBoxOnOffButtonBackground;
                this.btnOff.Appearance.BorderColor = MOGV.gTheme.CheckBoxOnOffButtonBorder;
                this.btnOn.Appearance.BackColor = MOGV.gTheme.CheckBoxOnOffButtonBackground;
                this.btnOn.Appearance.BorderColor = MOGV.gTheme.CheckBoxOnOffButtonBorder;

                // Enable 상태가 아닌 경우
                if (base.Enabled == false)
                {
                    this.lblOnText.Appearance.BackColor = MOGV.gTheme.ControlCommonDisabledBackground;
                    this.lblOnText.Appearance.ForeColor = MOGV.gTheme.ControlCommonDisabledForeground;
                    this.lblOffText.Appearance.BackColor = MOGV.gTheme.ControlCommonDisabledBackground;
                    this.lblOffText.Appearance.ForeColor = MOGV.gTheme.ControlCommonDisabledForeground;
                    this.btnOff.Appearance.BackColor = MOGV.gTheme.ControlCommonDisabledBackground;
                    this.btnOn.Appearance.BackColor = MOGV.gTheme.ControlCommonDisabledBackground;
                }
            }
        }
