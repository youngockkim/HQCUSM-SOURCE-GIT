    ...
    public partial class SOIChart : UltraChart
    {
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.BackColor = MOGV.gTheme.ChartBackground;
                this.Border.Color = MOGV.gTheme.ChartBorder;
                ...
                if (SOIChartType == OIFrx.SOIChartType.BarChart)
                {
                    ...
                    // 색상
                    this.Axis.Y.Labels.FontColor = MOGV.gTheme.ChartForeground;
                    this.Axis.Y.LineColor = MOGV.gTheme.ChartBarYLineBorder;                    
                }
                else if (SOIChartType == OIFrx.SOIChartType.PieChart)
                {
                    ...
                    this.PieChart.Labels.FontColor = MOGV.gTheme.ChartForeground;
        ...
        public void InitDataSource()
        {
            ...
            if (dt_chart_data == null)
            {
                ...
                // 최초 컬러 초기화
                this.ColorModel.CustomPalette = new Color[] { MOGV.gTheme.ChartBarDefaultBarColor };
        ...
        {
            return SetBarChartData(label, value, MOGV.gTheme.ChartBarDefaultBarColor, MOGV.gTheme.ChartForeground);
        }
        ...
        {
            return SetBarChartData(label, value, barColor, MOGV.gTheme.ChartForeground);
        }
