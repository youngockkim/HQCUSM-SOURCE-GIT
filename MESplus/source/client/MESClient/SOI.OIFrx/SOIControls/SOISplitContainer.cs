...
{
    public partial class SOISplitContainer : SplitContainer
    {
        #region Property
        ...
        public SOISplitContainer()
        {
            InitializeComponent();
        }

        public SOISplitContainer(IContainer container)
        {
            container.Add(this);
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상                
                this.BackColor = MOGV.gTheme.SplitContainerBackground;
            }
        }
