...
namespace SOI.OIFrx.SOIControls
{
    public partial class SOIContextMenu : UltraToolbarsManager
    {
        ...
        private PopupMenuTool menuTool = new PopupMenuTool(MOGC.CONTROL_CONTEXT_MENU_KEY);
        ...
        private ButtonTool btnToolExport = new ButtonTool("excelExport");
        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                // 공통 색상
                this.Appearance.BackColor = MOGV.gTheme.ContextMenuBackground;
                this.Appearance.BorderColor = MOGV.gTheme.ContextMenuBorder;
                this.Appearance.ForeColor = MOGV.gTheme.ContextMenuForeground;
                this.Appearance.ForeColorDisabled = MOGV.gTheme.ControlCommonDisabledForeground;
                this.MenuSettings.IconAreaAppearance.BackColor = MOGV.gTheme.ContextMenuBackground;
            }
        }
        ...
        public void SetTools(Control ctrl)
        {
            ...
            {
                // Button 속성 설정
                btnToolCut.SharedProps.Caption = MPOF.FindLanguage("Cut");                
                btnToolCopy.SharedProps.Caption = MPOF.FindLanguage("Copy");
                btnToolPaste.SharedProps.Caption = MPOF.FindLanguage("Paste");
                btnToolSelectAll.SharedProps.Caption = MPOF.FindLanguage("Select All");
            ...
            {
                // Button 속성 설정
                btnToolCopyCell.SharedProps.Caption = MPOF.FindLanguage("Copy Cell");
                btnToolCopyRow.SharedProps.Caption = MPOF.FindLanguage("Copy Row");
                btnToolExport.SharedProps.Caption = MPOF.FindLanguage("Export Excel");
