        ...
        public void SetOITheme()
        {
            if (_UseOITheme == true)
            {
                ...
                else
                {
                    ...
                    {
                        this.Appearance.BackColor = MOGV.gTheme.ButtonImageCloseBackground;
                        this.Appearance.BackColor2 = MOGV.gTheme.ButtonImageCloseBackground;
                        this.Appearance.BorderColor = MOGV.gTheme.ButtonImageCloseBackground;
                        this.Appearance.BorderColor2 = MOGV.gTheme.ButtonImageCloseBackground;
                        this.HotTrackAppearance.BackColor = MOGV.gTheme.ButtonImageCloseHoverBackground;
                        this.HotTrackAppearance.BackColor2 = MOGV.gTheme.ButtonImageCloseHoverBackground;
                        this.HotTrackAppearance.BorderColor = MOGV.gTheme.ButtonImageCloseHoverBackground;
                        this.HotTrackAppearance.BorderColor2 = MOGV.gTheme.ButtonImageCloseHoverBackground;
                        this.HotTrackAppearance.ForeColor = MOGV.gTheme.Foreground;
                        this.PressedAppearance.BackColor = MOGV.gTheme.ButtonImageClosePressBackground;
                        this.PressedAppearance.BackColor2 = MOGV.gTheme.ButtonImageClosePressBackground;
                        this.PressedAppearance.BorderColor = MOGV.gTheme.ButtonImageClosePressBackground;
                        this.PressedAppearance.BorderColor2 = MOGV.gTheme.ButtonImageClosePressBackground;
                        this.Cursor = Cursors.Default;
                    }
