...
{
    public partial class SOICodeView : UltraTextEditor
    {
        #region Property
        ...
        public SOICodeView(IContainer container)
        {
            container.Add(this);
        ...
        private void SOICodeView_Enter(object sender, EventArgs e)
        {
            bFocused = true;
            SetOITheme();
        }

        private void SOICodeView_Leave(object sender, EventArgs e)
        {
            bFocused = false;
            SetOITheme();
        }

        private void SOICodeView_MouseEnter(object sender, EventArgs e)
        {
            bMouseOver = true;
            SetOITheme();
        }

        private void SOICodeView_MouseLeave(object sender, EventArgs e)
        {
            bMouseOver = false;
            SetOITheme();
        }

        private void SOICodeView_TextChanged(object sender, EventArgs e)
        {
            if (DesignMode == true)
            {
                return;
        ...
        private void SOICodeView_Click(object sender, EventArgs e)
        {
        ...
        /// <returns></returns>
        public string Show(SOICodeView control, string popupTitle, string moduleName, string serviceName, TRSNode inNode,
            ...
            string listName, string[] displayColumn, string[] header, string selectedColumn, int pageSize)
        {
            ...
            try
            {
                ...
                // 신규 팝업 생성
                cvp = new frmCodeViewPopup();

                // 초기화
                if (cvp.InitCodeViewPopup((int)frmCodeViewPopup.VIEW_TYPE.TYPE_SERVICE, control, popupTitle, moduleName, serviceName, inNode, listName, displayColumn, header, selectedColumn, pageSize) == false)
                {
                    return sReturn;
                }
        ...
        /// <param name="selectedColumn"></param>
        /// <returns></returns>
        public string Show(SOICodeView control, string popupTitle, string queryID, string[] queryArgument,
            string[] displayColumn, string[] header, string selectedColumn)
        {
            return Show(control, popupTitle, queryID, queryArgument, displayColumn, header, selectedColumn, -1);
        }
            ...
            string[] displayColumn, string[] header, string selectedColumn, int pageSize)
        {
            ...
            try
            {
                ...
                // 초기화
                if (cvp.InitCodeViewPopup((int)frmCodeViewPopup.VIEW_TYPE.TYPE_DYNAMIC, control, popupTitle, queryID, queryArgument, displayColumn, header, selectedColumn, pageSize) == false)
                {
                    return sReturn;
                }
