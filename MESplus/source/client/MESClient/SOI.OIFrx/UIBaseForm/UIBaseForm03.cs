...
namespace SOI.OIFrx
{
    ...
    public partial class UIBaseForm03 : BaseForm02
    {
        public UIBaseForm03()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void UIBaseForm03_Activated(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UIBaseForm03_Load(object sender, EventArgs e)
        {
            try
            {
                MOGV.gsQueryStatementLong = Environment.NewLine + "#####[ " + DateTime.Now.ToString() + " ]####[ " + this.Name.ToString() + " ]####################\r\n";
        ...
        private void UIBaseForm03_FormClosed(object sender, FormClosedEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }
        #endregion

        private void UIBaseForm03_FormClosing(object sender, FormClosingEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }        
    }
