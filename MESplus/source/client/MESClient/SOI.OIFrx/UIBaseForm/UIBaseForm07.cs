...
namespace SOI.OIFrx
{
    ...
    public partial class UIBaseForm07 : BaseForm02
    {
        public UIBaseForm07()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void UIBaseForm07_Activated(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UIBaseForm07_Load(object sender, EventArgs e)
        {
            try
            {
                MOGV.gsQueryStatementLong = Environment.NewLine + "#####[ " + DateTime.Now.ToString() + " ]####[ " + this.Name.ToString() + " ]####################\r\n";
        ...
        private void UIBaseForm07_FormClosed(object sender, FormClosedEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }
        #endregion

        private void UIBaseForm07_FormClosing(object sender, FormClosingEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }        
    }
