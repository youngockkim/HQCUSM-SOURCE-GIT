...
namespace SOI.OIFrx
{
    ...
    public partial class UIBaseForm06 : BaseForm02
    {
        public UIBaseForm06()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void UIBaseForm06_Activated(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UIBaseForm06_Load(object sender, EventArgs e)
        {
            try
            {
                MOGV.gsQueryStatementLong = Environment.NewLine + "#####[ " + DateTime.Now.ToString() + " ]####[ " + this.Name.ToString() + " ]####################\r\n";
        ...
        private void UIBaseForm06_FormClosed(object sender, FormClosedEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }
        #endregion

        private void UIBaseForm06_FormClosing(object sender, FormClosingEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }        
    }
