...
namespace SOI.OIFrx
{
    ...
    public partial class UIBaseForm09 : BaseForm02
    {
        public UIBaseForm09()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void UIBaseForm09_Activated(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UIBaseForm09_Load(object sender, EventArgs e)
        {
            try
            {
                MOGV.gsQueryStatementLong = Environment.NewLine + "#####[ " + DateTime.Now.ToString() + " ]####[ " + this.Name.ToString() + " ]####################\r\n";
        ...
        private void UIBaseForm09_FormClosed(object sender, FormClosedEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }
        #endregion

        private void UIBaseForm09_FormClosing(object sender, FormClosingEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }        
    }
