/*---------------------------------------------------------------------------------------------------
    ...
    Description : Spread관련 로직(seoio@hanmail.net의 Logic을 Copy 사용함)
 
    History     : 
 *                2009.08.03 hyunggon kim.  -  Colums Lock 속성 추가
 *                2010.03.05 Sunghee Park.  재 생성하여 추가.
----------------------------------------------------------------------------------------------------*/
using System;
