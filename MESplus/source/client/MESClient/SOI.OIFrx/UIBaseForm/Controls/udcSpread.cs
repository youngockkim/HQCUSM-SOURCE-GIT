...
namespace SOI.OIFrx
{
    public partial class udcSpread : UserControl
    {
        public udcSpread()
        {
            InitializeComponent();
        ...
        public string m_gbTitle { get; set; }
       ...
       , Description("Context 칼럼 숨김 사용여부를 설정")]
        ...
        /// <param name="e"></param>
        private void udcSpread_Load(object sender, EventArgs e)
        {
            this.grpTranMiddle.Text = m_gbTitle;
        ...
        private void ApplyTema(bool bRowHeader, bool bSort, FarPoint.Win.Spread.OperationMode operMode)
        {
            ...
            try
            {
                ...
                this.spdData.BackColor = System.Drawing.Color.Silver;  //System.Drawing.SystemColors.Control; // System.Drawing.Color.Silver;
                ...
                for (int i = 0; i < this.spdData.Sheets.Count; i++)
                {
                    ...
                    this.spdData.Sheets[i].ColumnHeader.DefaultStyle.Font = new Font("맑은 고딕", 8.15F, System.Drawing.FontStyle.Regular);  // new Font("Tahoma", 8F, FontStyle.Bold);
        ...
        void ExcelExportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MPCF.ExportToExcel(m_upContext.spdData, this.grpTranMiddle.Text, sCond, true, false, true, -1, -1) == false)
                {
                    return;
                }
            }
