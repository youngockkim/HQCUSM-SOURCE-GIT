...
namespace SOI.OIFrx
{
    ...
    public partial class udcShop : UserControl, intCodeListControl
    {
        ...
        private void cdvShop_ButtonPress(object sender, EventArgs e)
        {
            ...
            cdvShop.Init();
            MPCF.InitListView(cdvShop.GetListView);
            cdvShop.Columns.Add("Shop", 100, HorizontalAlignment.Left);
            cdvShop.Columns.Add("Desc", 200, HorizontalAlignment.Left);
            cdvShop.SelectedSubItemIndex = 0;

            MPOF.MFillData(cdvShop.GetListView, "WIP_View_Shop_List_By_Plant", new string[] { MPCF.Trim(ListCond_Filter) });

            if (b_add_empty_row_to_top == true)
            {
                cdvShop.InsertEmptyRow(0, 1);
            }
            if (b_add_empty_row_to_last == true)
            {
                cdvShop.AddEmptyRow(1);
            }
        ...
        private void cdvShop_SelectedItemChanged(object sender, MCCodeViewSelChanged_EventArgs e)
        {
            if (SelectedItemChangedEvent != null)
                SelectedItemChangedEvent(this, e);
        }

        private void cdvShop_TextBoxGotFocus(object sender, EventArgs e)
        {
            if (TextBoxGotFocusEvent != null)
                TextBoxGotFocusEvent(this, e);
        }

        private void cdvShop_TextBoxKeyPress(object sender, KeyPressEventArgs e)
        {
            cdvShop_ButtonPress(null, null);
        }

        private void cdvShop_TextBoxLostFocus(object sender, EventArgs e)
        {
            if (TextBoxLostFocusEvent != null)
                TextBoxLostFocusEvent(this, e);
        }

        private void cdvShop_TextBoxTextChanged(object sender, EventArgs e)
        {
        ...
        public new bool Enabled
        {
            get
            {
                return cdvShop.Enabled;
            }
            set
            {
                cdvShop.Enabled = value;
            }
        }
        ...
        public bool IsPopup
        {
            get
            {
                return cdvShop.IsPopup;
            }
            set
            {
                cdvShop.IsPopup = value;
            }
        }
        ...
        public string DisplayText
        {
            get
            {
                return cdvShop.DisplayText;
            }
            set
            {
                cdvShop.DisplayText = value;
            }
        }
        ...
        public string DescText
        {
            get
            {
                return cdvShop.DescText;
            }
            set
            {
                cdvShop.DescText = value;
            }
        }
        ...
        public new Color BackColor
        {
            get
            {
                return cdvShop.BackColor;
            }
            set
            {
                cdvShop.BackColor = value;
                lblShop.BackColor = value;
            }
        }
        ...
        public int ButtonWidth
        {
            get
            {
                return cdvShop.ButtonWidth;
            }
            set
            {
                cdvShop.ButtonWidth = value;
            }
        }
        ...
        public int TextBoxWidth
        {
            get
            {
                return cdvShop.TextBoxWidth;
            }
            set
            {
                cdvShop.TextBoxWidth = value;
            }
        }
        ...
        public int MaxLength
        {
            get
            {
                return cdvShop.MaxLength;
            }
            set
            {
                cdvShop.MaxLength = value;
            }
        }
        ...
        public int SelectedSubItemIndex
        {
            get
            {
                return cdvShop.SelectedSubItemIndex;
            }
            set
            {
                cdvShop.SelectedSubItemIndex = value;
            }
        }
        ...
        public int DisplaySubItemIndex
        {
            get
            {
                return cdvShop.DisplaySubItemIndex;
            }
            set
            {
                cdvShop.DisplaySubItemIndex = value;
            }
        }
        ...
        public int SelectedDescIndex
        {
            get
            {
                return cdvShop.SelectedDescIndex;
            }
            set
            {
                cdvShop.SelectedDescIndex = value;
            }
        }
        ...
        public int SearchSubItemIndex
        {
            get
            {
                return cdvShop.SearchSubItemIndex;
            }
            set
            {
                cdvShop.SearchSubItemIndex = value;
            }
        }
        ...
        public bool ReadOnly
        {
            get
            {
                return cdvShop.ReadOnly;
            }
            set
            {
                if (value == true)
                    cdvShop.BackColor = this.BackColor;
                else
                    cdvShop.BackColor = SystemColors.Window;
                cdvShop.ReadOnly = value;
            }
        }
        ...
        public bool VisibleButton
        {
            get
            {
                return cdvShop.VisibleButton;
            }
            set
            {
                cdvShop.VisibleButton = value;
            }
        }
        ...
        public bool VisibleDescription
        {
            get
            {
                return cdvShop.VisibleDescription;
            }
            set
            {
                cdvShop.VisibleDescription = value;
            }
        }
        ...
        public bool VisibleColumnHeader
        {
            get
            {
                return cdvShop.VisibleColumnHeader;
            }
            set
            {
                cdvShop.VisibleColumnHeader = value;
            }
        }
        ...
        private void udcShop_FontChanged(object sender, EventArgs e)
        {
            cdvShop.Font = this.Font;
        }
        ...
        {
            return MPCF.CheckValue(this.cdvShop, 1);
        }
        ...
        private void cdvShop_MouseClick(object sender, MouseEventArgs e)
        {
            cdvShop_ButtonPress(null, null);
        }

        private void cdvShop_MouseDown(object sender, MouseEventArgs e)
        {
            cdvShop_ButtonPress(null, null);
        }
