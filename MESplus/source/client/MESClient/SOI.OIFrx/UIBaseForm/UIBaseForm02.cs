...
namespace SOI.OIFrx
{
    ...
    public partial class UIBaseForm02 : BaseForm02
    {
        public UIBaseForm02()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void UIBaseForm02_Activated(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UIBaseForm02_Load(object sender, EventArgs e)
        {
            try
            {
                MOGV.gsQueryStatementLong = Environment.NewLine + "#####[ " + DateTime.Now.ToString() + " ]####[ " + this.Name.ToString() + " ]####################\r\n";
        ...
        private void UIBaseForm02_FormClosed(object sender, FormClosedEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }
        #endregion

        private void UIBaseForm02_FormClosing(object sender, FormClosingEventArgs e)
        {
            MiscUtil.HideStatusMessage();
        }        
    }
