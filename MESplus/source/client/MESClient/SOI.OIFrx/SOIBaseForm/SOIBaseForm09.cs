...
{
    public partial class SOIBaseForm09 : Form
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void SOIBaseForm09_Load(object sender, EventArgs e)
        {
            //if (DesignMode == true)
            //{
            //    SetOITheme();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SOIBaseForm09_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (MOGV.gIBaseFormEvent != null)
            ...
            {
                MPOF.ShowMessage("SOIBaseForm09_FormClosed() \n" + ex.Message, MSSAG_LEVEL.ERROR, false);
            }
        }
