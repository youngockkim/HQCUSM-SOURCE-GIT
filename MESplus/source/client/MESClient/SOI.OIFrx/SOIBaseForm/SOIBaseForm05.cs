...
{
    public partial class SOIBaseForm05 : Form
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void SOIBaseForm05_Load(object sender, EventArgs e)
        {
            //if (DesignMode == true)
            //{
            //    SetOITheme();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SOIBaseForm05_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (MOGV.gIBaseFormEvent != null)
            ...
            {
                MPOF.ShowMessage("SOIBaseForm05_FormClosed() \n" + ex.Message, MSSAG_LEVEL.ERROR, false);
            }
        }
