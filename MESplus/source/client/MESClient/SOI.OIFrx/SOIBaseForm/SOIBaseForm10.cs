...
{
    public partial class SOIBaseForm10 : Form
    {
        #region Property
        ...
        /// <param name="e"></param>
        private void SOIBaseForm10_Load(object sender, EventArgs e)
        {
            //if (DesignMode == true)
            //{
            //    SetOITheme();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SOIBaseForm10_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (MOGV.gIBaseFormEvent != null)
            ...
            {
                MPOF.ShowMessage("SOIBaseForm10_FormClosed() \n" + ex.Message, MSSAG_LEVEL.ERROR, false);
            }
        }
        ...
        public void DisplayMessage(string sMessage, MSSAG_LEVEL msgLevel)
        {
            ...
            switch (msgLevel)
            {
                ...
                case MSSAG_LEVEL.ERROR:
                    ...
                    lblMessage.Text = sMessage;
                    lblMessage.ForeColor = Color.Orange; // 가독성 문제로 Red 에서 Orange로 변경
                    break;
