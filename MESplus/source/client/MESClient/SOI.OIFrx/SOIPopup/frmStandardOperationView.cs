...
namespace SOI.OIFrx.SOIPopup
{
    public partial class frmStandardOperationView : frmModalessPopupBase
    {
        ...
        private void frmStandardOperationView_Load(object sender, EventArgs e)
        {
            ...
            // Check PLM Url
            if (string.IsNullOrEmpty(MOGC.PLM_VIEWER_URL) == true)
            {
        ...
        {
            System.Diagnostics.Process.Start(MOGC.PLM_VIEWER_URL);
        }
        ...
        private void SetFormSize()
        {
            ...
            if (this.Width > MOGV.gfrmMDI.Width)
            {
                this.Width = MOGV.gfrmMDI.Width;
            }
            this.Height = pbImage.Image.Size.Height + (this.Height - pnlImageBack.Height);
            if (this.Height > MOGV.gfrmMDI.Height)
            {
                this.Height = MOGV.gfrmMDI.Height;
            }
        ...
        {
            this.Left = MOGV.gfrmMDI.Left + (MOGV.gfrmMDI.Width / 2) - (this.Width / 2);
            this.Top = MOGV.gfrmMDI.Top + (MOGV.gfrmMDI.Height / 2) - (this.Height / 2);
        }
