...
{
    public partial class udcResourceTreeList01 : UserControl
    {
            ...
            for (i = 0; i < 3; i++)
            {
                if (a_level[i].Equals(sender) == true)
                {
                    ...
                    switch (i)
                    {
                        ...
                        case 1:
                            m_select_level = ResourceSelectLevel.G; break;
                        case 2:
                            m_select_level = ResourceSelectLevel.T; break;
                    }
                }
                else
                {
        ...
        {           
            ...
            else if (m_select_level == ResourceSelectLevel.G)
            {
                if (RASLIST.ViewResourceGroupList(treResourceList, '1') == false) return;
            }
            else if (m_select_level == ResourceSelectLevel.T) 
            {
