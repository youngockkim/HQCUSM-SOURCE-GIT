...
namespace Miracom.MESCore.Controls
{
    public partial class udcFromToDate : UserControl
    {
        public udcFromToDate()
        {
            ...
            foreach (DateConditionType conditionType in Enum.GetValues(typeof(DateConditionType)))
            { 
                this.cboConditionType.Items.Add(conditionType);                 
            }

            this.cboConditionType.SelectedItem = _ConditionType;
        }

        public enum DateConditionType
        {
            //당일, 전일, 전전일, 당주, 전주, 당월, 전월, 기간 ,
                CurrentDay, Yesterday, BeforeYesterday, CurrentWeek, LastWeek, CurrentMonth, LastMonth, Period
        };
        ...
        //  DataTimePicker 의 타입
        private DateConditionType _ConditionType = DateConditionType.CurrentDay;
        ...
        [Browsable(true), Category("Miracom.MESCore.Controls"), Description("세로 방향")]
        ...
        [Browsable(true), Category("Miracom.MESCore.Controls"), Description("세로 순서")]
        ...
        , Category("Miracom.MESCore.Controls"), Description("라벨 Size")]
        ...
        , DefaultValue(LayoutType.Horizontal)
        , Category("Miracom.MESCore.Controls"), Description("라벨 Font")]
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)
        , DefaultValue(LayoutType.Horizontal)
        , Category("Miracom.MESCore.Controls"), Description("언어 옵션")]
        ...
        , Category("Miracom.MESCore.Controls")]
        ...
        public string FromDateTime
        {
            get
            {
                ...
                {
                    return this.dtpFromDate.Value.ToString("yyyyMMdd") + "000000";
                }
            }
        }
        ...
        public string ToDateTime
        {
            get
            {
                ...
                {
                    return this.dtpToDate.Value.AddDays(1).ToString("yyyyMMdd") + "235959";
                }
        ...
        public DateConditionType ConditionType
        {
            ...
            set
            {
                ...
                //if (_ConditionType == DateConditionType.당일)
                //{
                ...
                //    this.cboConditionType.Text = _ConditionType.ToString();
                //}
                //else if (_ConditionType == DateConditionType.당주)
                //{
                //    if (_CalendarID == "")
                //    {
                ...
                //    this.cboConditionType.Text = _ConditionType.ToString();
                //}
                //else if (_ConditionType == DateConditionType.당월)
                //{
                ...
                //English
                if (_ConditionType == DateConditionType.CurrentDay)
                {
                    this.dtpToDate.Value = DateTime.Today;
                    this.dtpFromDate.Value = DateTime.Today;
                    this.dtpFromDate.Enabled = false;
                ...
                else if (_ConditionType == DateConditionType.Yesterday)
                {
                    this.dtpToDate.Value = DateTime.Today.AddDays(-1);
                    this.dtpFromDate.Value = DateTime.Today.AddDays(-1);
                    this.dtpFromDate.Enabled = false;
                ...
                else if (_ConditionType == DateConditionType.BeforeYesterday)
                {
                    this.dtpToDate.Value = DateTime.Today.AddDays(-2);
                    this.dtpFromDate.Value = DateTime.Today.AddDays(-2);
                    this.dtpFromDate.Enabled = false;
                ...
                else if (_ConditionType == DateConditionType.CurrentWeek)
                {
                    if (_CalendarID == "")
                    {
                        int addFromDay = (int)DateTime.Today.DayOfWeek - 1;
                ...
                else if (_ConditionType == DateConditionType.LastWeek)
                {
                    if (_CalendarID == "")
                    {
                        int addFromDay = (int)DateTime.Today.DayOfWeek - 1;
                ...
                else if (_ConditionType == DateConditionType.CurrentMonth)
                {
                ...
                else if (_ConditionType == DateConditionType.LastMonth)
                {
                    this.dtpToDate.Value = new DateTime(DateTime.Today.Year, DateTime.Today.Month, 1).AddDays(-1);
                    this.dtpFromDate.Value = new DateTime(DateTime.Today.Year, DateTime.Today.AddMonths(-1).Month, 1);                    
                    this.dtpFromDate.Enabled = false;
