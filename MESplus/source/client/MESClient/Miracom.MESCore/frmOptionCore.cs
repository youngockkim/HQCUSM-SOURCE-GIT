    ...
    public class frmOptionCore : System.Windows.Forms.Form
    {
        ...
        private void frmOption_Activated(object sender, System.EventArgs e)
        {
            ...
            if (b_load_flag == false)
            {
                ...
                // Added fo QCELLS
                if (MPCF.Trim(MPCF.GetRegSetting(Application.ProductName, "Option", "SiteID0", "")) == "")
                {
                    // Save 
                    MPCF.SaveRegSetting(Application.ProductName, "Option", "SiteID0", "MPP1");
                    MPCF.SaveRegSetting(Application.ProductName, "Option", "RemoteAddress0", "10.60.110.12;10.60.110.13");
